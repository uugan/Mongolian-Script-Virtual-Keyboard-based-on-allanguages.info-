...
VirtualKeyboard.Langs.IKU = new
function () {
    var i = /[^acefghijklłmnopqrstuvwxyᖃᐁᕋᑕᐂᐅᐃᐸᐊᓴᖕᒐᕼᔭᑲᓚᖤᕙᓇᒪ]/,
        I = {
            'ᐊi': 'ᐁ',
            'ᐃi': 'ᐄ',
            'ᐅu': 'ᐆ',
    ...
    this.charProcessor = function (O, Q) {
        if (O == '\u0008') {
            if (Q.length) {
                return [Q.slice(0, -1), Q.length - 1]
            }
        } else if (i.test(O)) {
            return I[Q + O] || [Q + O, 0]
        } else {
...
VirtualKeyboard.Langs.JP = new
function () {
    var i = this,
        I = {
            a: "日会四上合開明相当海安挙朝在空有足愛英赤歩悪登編厚我称充荒網揚阿遇麻浴亜芦吾晶遭唖娃逢宛或粟庵厭蛙敢窪鹸昂朱讐飽亞會呀哇嗟堊婀惡扛擧舉猗當痾稱辮翕翹褪襾覯覿逅遘邂錏鐚閼齏韲驤鴉",
            aa: "悪於乎于吁咨嗚嗟噫惡憙猗羌",
            aba: "発暴發訐",
            abara: "肋",
            abu: "危虻蛇炙炮焙煬熹",
            ...
            ahiru: "鴨鶩",
            ahu: "溢",
            ai: "会合間東相和愛英秋娃哀挨姶逢鮎饗乃廼藍會哇噫埃曖欸瞹矮穢胥藹迺阨隘靄靉鞋",
            aida: "間",
            aite: "対對",
            aka: "明赤厚紅赫垢朱緋淦絳",
            akagane: "銅",
            ...
            ake: "明陽暁朱緋",
            akebono: "曙",
            aki: "日明成商天光白秋右清喜昭之陽章照哲徹旭輝啓昌朗鑑鏡晃彰祥顕晶亮穐叡瑛且亨尭暁倦昂燦嗣朱詮爽聡旦諦寧彬斌呆飽璃諒玲奐惘曉曄朖皓睿龝飫",
            akina: "商估賈",
            akira: "明現公成審映光史融央昭陽章智哲旭輝啓昌朗鑑晃彰顕晶亮卯瑛侃亨暁慧昂翠聡旦諦瞳彪彬諒玲昶熹皓聰",
            akiraka: "煕晃顕亮瞭冏杲晄晤晟晢晰暸曠昿渙炯烱炳煥熈顯熙",
            akitarinai: "歉",
            akitariru: "慊",
            akizora: "旻",
            ako: "赤",
            ...
            ato: "後跡痕蹟址墟趾蹤踪迹阯",
            atu: "会集得熱圧安厚",
            atu: "徳温純充宏昌淳暑敦鳩渥斡纂蒐輯鍾篤惇睦湊亶會壓扎攅聚腆萃軋輳遏閼",
            atui: "醇",
            atuka: "扱",
            atumari: "集",
            atumono: "羹羮",
            ...
            atusi: "温毅淳敦渥竺惇",
            au: "合",
            awa: "併阿淡哀粟慌泡沫怜憐勠并怱恊恤愍澹矜粱遽醂閔",
            awabi: "蚫鮑鰒",
            aware: "憫",
            awase: "袷",
            awatada: "遽",
            awati: "莱",
            aya: "理文史危順恵章礼錦奇彩怪紋絢綾郁苑琢斐彪妖冉竒恠愆綺綵黻黼",
            ayaginu: "綵",
            ayaka: "肖",
            ayama: "過誤謝謬繆訛譌",
            ayamatu: "跌",
            ...
            azuma: "東春",
            azusa: "梓",
            ba: "場発化張映馬羽庭栄晴峡婆罵芭蕃塲麼旛瑪痲發碼薔蟇蟆鷭",
            baa: "婆",
            baba: "婆",
            bai: "売買倍枚梅賠培貝唄殻媒楳煤狽陪昧殼瑁眛苺莓賣邁霾黴",
            baku: "博暴爆幕麦曝漠縛莫駁貌摸寞瀑狢獏皃藐貘驀麥",
            ban: "万判番満馬板伴盤幡晩鰻播挽磐蕃蛮蔓卍曼幔悗滿瞞礬縵萬蠻謾輓鈑鑁鬘鷭",
            bara: "散払茨輩",
            baru: "原",
            bas: "罰",
            base: "橋",
            ...
            bati: "罰撥枹桴秡罸",
            batta: "蝗",
            batu: "末抜閥罰伐筏沫拔秣罸茉袙襪跋靺韈魃",
            be: "部米家可辺弁志倍缶瓶琶罐裴邊邉",
            bei: "米皿謎塀吠榠袂麑",
            beki: "冖冪幎汨羃覓",
            bekikanmuri: "冖",
            ben: "面弁便勉釆娩鞭緬麺俛冕辨辧卞宀抃汳泯湎瓣眄瞑辮辯麪黽",
            beni: "紅臙",
            bentou: "餉",
            besi: "志",
            betu: "別捌瞥蔑襪韈鼇鼈",
            bi: "日引備美火未尾老敏微梶弥鼻傍枇毘琵眉媚寐嵋麼弭彌濔瀰糒糜縻茯薇鞴麋靡黴",
            bibi: "周",
            bii: "為",
            biki: "引曳曵",
            bikko: "跛",
            bin: "備便敏貧瓶秤壜岷愍憫旻檳泯紊緡罎罠閔鬢黽",
            bira: "開",
            bita: "鐚",
            bitu: "蜜備",
            bo: "母模募暮干簿彫墓姥牡蒲惚莫慕戊菩呆摸姆媽拇毋糢謨",
            boka: "暈",
            bokasi: "暈",
            boko: "凹",
            boku: "目福木撲牧僕黙墨朴曝卜睦穆樸濮瀑默繆苜蹼雹鶩",
            bokudukuri: "攴攵",
            bokunoto: "卜",
            bokunyou: "攴攵",
            bon: "犯盆煩凡梵瞞笵",
            ...
            boti: "点伐筏垈點",
            botu: "没勃勿孛悖歿沒渤坊",
            bou: "防望貿亡暴房夢忘膨妨忙冒謀乏傍坊帽棒紡牟矛霧虻卯牡茅畝戊剖某肪貌鉾妄孟蒙儚勗夘厖厶梦尨惘懋旁旄昴曚朦楙榜氓滂瀑瑁甍畆皃眸矇磅网罔耄冐膀艨芒茆茫莽蒡蚌蠎蟒袤謗鋩髦魍鴾黽",
            bu: "分部不保海打無夫武振歩豊舞歓奉峰霧蒲蔀舛汎賦侮撫葡蕪鮒蓬鵡嘸廡憮无毋豐錻鵐鶩",
            buka: "深",
            buki: "雪",
            buku: "袋茯",
            bun: "分文聞豊蚊吻紊馼",
            ...
            buyu: "蚋",
            byaku: "百白柏檗蘗甓闢",
            byou: "平病秒描妙猫苗鞄謬廟錨鋲屏杪渺皰眇緲苹藐蚌鉋",
            byuu: "謬繆",
            da: "出立建打達伊抱妥那炊駄雫蔀蛇詑唾堕惰柁舵楕陀騨儺兌墮娜懦拏拿朶梛橢沱默糯荼蠕逹陏駝鴕",
            daasu: "打",
            dai: "大内代題第台提奈袋弟鵜醍悌梯乃廼眤睇臺迺餒鹹",
            daidai: "橙",
            dainomageasi: "尢",
            daira: "平",
            daka: "高瀉",
            ...
            deko: "凸",
            deku: "塑",
            den: "田電伝典殿淀鮎佃纏澱傅傳甸奠拈畋沺癜臀鈿",
            desiguramu: "瓰",
            desimeetoru: "粉",
            desirittoru: "竕",
            detu: "涅",
            'do': "百度取道水止土退友遠努撮怒豆澱奴曇呶孥帑弩迹駑",
            dobato: "鴿",
            dobu: "溝",
            dobuga: "蚌",
            doitu: "独",
            ...
            doru: "取弗",
            dotu: "独",
            dou: "同百動道藤導働答登脳堂童桐洞銅吋寓竣憧撞瞳胴萄嚢膿仂僮儂呶嬲嫐恫慟曩橈檸潼獰瞠耨腦臑艟衲鐃閙鬧",
            dougamae: "冂",
            dousi: "通",
            dozyou: "鰍鯲鰌",
            duke: "付漬附",
            ...
            ega: "画描畫",
            egu: "刔刳剔抉",
            ei: "営映英影衛永栄泳鋭叡嬰曳洩瑛盈穎頴詠丿兌咏營塋暎曵楹榮殪泄潁瀛瑩瓔珱睿縊纓罌翳蠑衞裔贏郢霙饐",
            eki: "役益易駅液浴疫伯亦奕懌掖繹腋蜴蝪覓謚諡驛鯣",
            ekubo: "靨",
            emi: "笑蝦",
            emisi: "夷",
            en: "円演援園渉延圧遠沿塩炎煙縁垣媛渕堰鉛宛咽厭奄宴怨掩焔燕猿艶苑薗鴛俺羨鳶淵偃冤嚥圓圜壓娟婉嫣寃悁捐掾椽檐櫞衍涎淹渊湮湲烟焉爰筵篶簷罨臙艷茆莚蜒蜿袁覃讌豌轅鋺閼閻閹隕魘鹽黶",
            enagamae: "冂",
            enisi: "縁",
            ennyou: "廴",
            eno: "榎",
            ...
            gae: "谷",
            gaenzi: "肯",
            gai: "外害谷街垣概刈涯亥凱劾咳崖慨碍蓋該鎧骸苅乂倪儿剴匯啀喙垓孩乢崕崔愾榿漑皚盖睚磑礙葢豈駭鮠",
            gakari: "係掛",
            gake: "崖垳崕崔",
            gaki: "書城",
            gaku: "学額楽岳顎鍔鰐咢壑學斈嶽愕樂瘧萼蕚覺諤鄂鶚齶",
            gakusi: "隠",
            gama: "蒲",
            gami: "頭模耳尻",
            gan: "元含丸顔岩岸願頑眼巌玩癌翫贋雁偐嵒巖狠芫莟頷顏鴈鳫龕",
            gandare: "厂",
            gane: "金",
            gara: "潟柄殻搦",
            gasa: "笨",
            ...
            gawa: "代側",
            gaya: "谷",
            ge: "下外解夏芸植削殖霞蝦牙崖碍戯乂偈戲皚礙觧訝鮠",
            gei: "児芸迎鯨詣倪兒囈猊睨艾藝貎霓鯢麑黥",
            geki: "撃激劇逆戟隙屐檄覡郤闃鬩鵙鷁",
            gen: "現言原元減限験厳源彦嫌眼玄幻弦拳硯絃舷諺這偐儼呟咸嚴广愿狠痃眩芫衒阮驗",
            geti: "杰",
            getu: "月綴囓蘖齧",
            gi: "十議子決調切疑義着技親極儀岐貴犠衣偽裂伎毅宜欺蛾崖妓戯擬祇蟻誼其鰭僞嵬嶬嶷巍戲曦沂犧皚礒羲艤萓魏",
            gihunohu: "阜",
            gimi: "君",
            gin: "銀吟圻垠岑崟很憖沂齦",
            ginu: "被",
            giri: "切",
            giwa: "際",
            go: "五後期午語護越降互砂拒御豪誤牛悟剛棋呉吾后禦糊胡伍娯梧檎瑚碁醐冴其冱唔圄圉寤忤晤朞棊沍牾珸篌茣蜈衙麌齬",
            goe: "越",
            gokoro: "心",
            goku: "極獄",
            gome: "込篭籠",
            ...
            gosi: "越",
            goto: "毎如",
            gou: "業合強格楽号豪郷剛旺噛彊昂劫壕拷濠轟傲刧哈嗷囂抂敖樂毫熬藕螯遨鰲鷙鼇",
            gouri: "群",
            goya: "越",
            goza: "厶蓙",
            gu: "工求木宮供具居弘群呉臼仇倶愚虞寓吽嵎柩禺藕裘颶鬨麌",
            gui: "食",
            gumi: "実組",
            gumo: "雲",
            gun: "軍郡群羣",
            ...
            hahaso: "柞",
            hahuri: "葬",
            hai: "入配敗廃抜背排杯俳肺輩灰拝榛盃牌狽蝿誹稗箆吠孟佩坏孛廢徘怫悖憊拔抔拜擺旆朏沛湃焙珮琲癈碚祓篦糒胚蠅裴霈",
            haitaka: "鷂",
            haka: "高経権画計量図博測略称諮墓謀諏猷仞仭咨圖塋忖揆揣權畧畫稱經詢謨銓",
            hakado: "捗",
            hakama: "袴",
            hakana: "儚",
            hakari: "秤",
            hakarigoto: "画略謀猷揆畧畫籌",
            hakimono: "屐",
            hako: "運箱函笥漕箪凾匣匳奩椢筐筺筥篋",
            hakogamae: "匚",
            haku: "白博迫薄覇泊拍伯柏鞄栢狛剥箔粕舶駁亳佰岶帛怕搏擘霸樸檗蘗溥瀑狢珀璞膊貉貊陌雹駮魄",
            hama: "浜濱",
            hamaguri: "蛤蚌",
            hamasuge: "莎",
            hamati: "鰤",
            hamo: "鱧",
            han: "府判反阪半販般坂版犯板伴範飯繁幡漢搬班翻榛播叛帆斑氾汎畔藩釆煩頒磐蕃扮焚凡卞拌攀旛旙槃樊泛潘燔瘢礬笵絆繙飜胖膰范蟠袢蹣鈑鐇鷭",
            ...
            hato: "鳩鴿",
            hatoba: "埠",
            hatu: "八発初抜法白服削泊罰髪鉢捌廿肇溌醗伐筏叭垈撥癶發秡罸跋釟髮魃",
            hatugasira: "癶",
            haya: "早速勇逸捷隼囃湍趾駛鮠",
            hayabusa: "隼鶻",
            hayai: "斉夙蚤齊",
            ...
            hebi: "蛇它",
            heda: "距隔鬲",
            hei: "平病兵並恵併閉柄瓶陛坪丙塀幣弊蔽僻箆餅俾凭娉嬖屏幤幵并憊敝斃枋炳睥砒秉竝篦聘苹萍蓖薜閇閖餠髀鮃",
            heki: "壁僻癖碧劈擘璧甓襞躄辟闢霹",
            heko: "凹",
            hekutoguramu: "瓸",
            hekutomeetoru: "粨",
            hekutorittoru: "竡",
            hen: "平変返辺弁編片偏逸扮篇遍鞭辨辧卞扁變旛旙汳瓣辮翩胼蝙褊諞貶辯邊邉駢騙",
            hena: "埴",
            hera: "箆篦",
            heri: "縁",
            herikuda: "遜",
            ...
            heya: "曹",
            hezu: "剥",
            hi: "日一理平引費井比常英被退春火非飛否批冷等彼避秘陽弾悲旭似皮干輝陳肥孫灯披疲乾妃碑氷曳轡牽冴惹燈挽匪卑庇扉斐泌緋罷誹樋簸枇毘琵稗桧僻婁丕俾冱冰匕嚊坡妣婢屁彈彎弯怫拏拿掎掣攣暃曵朏杼檜梭榧沍狒痞痺砒碾祕秕粃紕絅羆翡脾腓臂茯菲蓖蜚裴裨譬貔豼賁贔跛輓轢辟鄙陂霏鞁鞴髀鯡鵯靡",
            hibi: "響皴皸皹罅",
            hibiki: "韵",
            hida: "摺襞",
            hidari: "左",
            ...
            hiratai: "扁",
            hire: "鰭",
            hiro: "大公海広容展太洋周央欧博拡幸普彦宇緩弘陽敬宗裕宏浩仁煕啓聖泰宙倫嘉寛祥尋拓弥郭拾伯祐丑恢紘氾汎凡廣擴敞汪洸滉瀚熈皓碵禮胖豁闊濶熙",
            hiromu: "弘",
            hiron: "寛",
            hirosi: "大海洋豊宇弘裕宏浩礼煕寛祐紘汎洸皓",
            hiru: "昼怯蒜蛭晝",
            hiruga: "翩飜飄飃",
            hirugae: "翻",
            hisa: "長教史久央永宣亀寿恒剛尚弥桐粥玖壽廂彌鬻",
            hisagi: "楸",
            hisago: "瓢匏瓠蠡",
            hisame: "霈",
            ...
            hiziri: "聖",
            hizu: "歪",
            ho: "法保反補種捕火賞歩豊浦秀欲緒布宝誉掘干舗穂彫灯怖芳乾輔峰蒲惚讃畝捗燈帆埠葡鮒鋪圃甫蜂褒吠匍匏吼咐咆哮哺埔堡娉恍枋枹畆穗脯舖苹菠葆褓襃譽讚逋鐫雕餔鮑鯆黼",
            hobasira: "檣艢",
            hobi: "統",
            hobo: "略畧",
            hoda: "絆",
            ...
            hotori: "阿瀕滸濆陲",
            hotu: "上発北払勃拂渤發法堀",
            hou: "方法保北報放防訪並豊崩抱邦宝包封砲庄胞芳棚奉峰縫朴逢鞄亨蔀鴇汎豹倣俸呆峯庖捧朋泡烹萌蓬蜂褒鋒飽鳳鵬勹匏匚咆垉堋堡娉寶寳幇弸彭彷怦抔抛旁枋枹榜泛泙滂澎瀑炮烽焙琺疱皰硼磅竝篷絣繃膀舫苹苞萠葆蒡蚌蚫袍裹褓襃謗豐迸鉋靤髣髱魴鮑麭",
            houdate: "楔",
            houki: "荘帚彗箒莊菷",
            houmu: "葬",
            hourensou: "菠薐",
            hozisi: "脩脯膊",
            hozo: "臍",
            hu: "二五生部化不文府増付福夫負風振船婦歩富降父踏普浮老更触阜布吹敷腐双缶殖怖伏噴釜践冨符膚赴輔嘘嬰臥蒲拭耽斑埠扶斧芙譜賦附撫葺鮒鋪圃甫仆俘俛俾俯偃傅吩咐坿孚孵巫拊枹柎桴榑殍殕溥牴畉罐罘脯腑艀苻藉蜉觝觸訃誣賻趺跋踐蹂蹈躔躙躪躡逋郛酖釡餔馮鯆鳧鳬麩麸黼",
            huda: "二札牒牌榜槧牘箋",
            hude: "筆翰聿",
            hudedukuri: "聿",
            hue: "笛笙簫籟籥鰾龠",
            ...
            huka: "外深泓浤潭鱶",
            huki: "福吹葺蕗擽苳",
            huku: "福副含復幅服複腹膨伏覆巾脹逼匐哺愎箙茯蔔蝠蝮袱輻輹鞴馥鰒",
            hukube: "瓢",
            hukurahagi: "腓",
            hukuro: "袋嚢梟",
            humaki: "帙",
            ...
            hyatu: "百",
            hyoku: "逼愎溽皀雹馥",
            hyou: "表平票評兵標拍俵氷漂杓彪瓢豹餅冫冰凭剽嫖并怦慓憑殍澎縹繃苞萍迸雹飄飃飆餠馮驃髟鮃鰾",
            hyousigi: "柝",
            hyuku: "百",
            hyuu: "彪髟",
            ...
            imoto: "姨",
            imouto: "妹姨",
            'in': "員院引音印因飲隠陰允咽姻淫胤蔭韻寅吽堙婬尹廴恁慇飮殞殷氤湮筍笋茵蚓贇酳隕隱霪韵鸚",
            ina: "員引否辞稲稻",
            inada: "鰍",
            inago: "蝗螽",
            inaka: "田",
            ...
            isoga: "忙惣匆",
            isu: "石",
            ita: "分労傷致板痛至潮到惨悼詣戚俎勞廸怛恫悵惻愴慘摯炒疼臻迪",
            itada: "頂戴",
            itadaki: "頂顛巓",
            itama: "愴",
            itamu: "悽",
            ...
            kaho: "薫",
            kahoru: "馨薫",
            kai: "会回開海改界画解階競介壊街届絵掛戒械快悔皆刈飼怪懐拐灰貝堺柏亥頴塊廻恢魁晦芥蟹凱咳蓋鎧骸粥苅卦罫鮭詮潰桧丐乂乖价會偕傀囘剴匯哇咼喙喟垓壞夬孩屆峽嵬廨徊恠懷懈挂揩枴檜椢楷楫槐榿橈櫂欸歇淮漑獪瑰畍畫疥皚盖鬻繪膾艪艾茴葢薤薈薊蛔蠏褂觧詼誨誡諧豈迴邂醢醯隗鞋駭鮠鱠",
            kaibaoke: "櫪",
            kaigarabone: "胛",
            kaiko: "蚕蠶",
            kaina: "肱",
            ...
            kakotu: "託寓詫",
            kakou: "蓋盖葢",
            kaku: "画各革格確客閣蔵核拡覚角秘隠獲較鶴隔脚潜渕穫郭碓劃嚇廓撹殻赫掴塙淵凅喀咯埆壑幗恪愨挌攪擱擴攫桷梏椁槨殼渊涸潛濳烙狢瓠畫癨矍硅祕竄膈膕茖藏螫蟄蠖覈覺貉钁隱霍馘駮骼鬩鬲鷽",
            kakuma: "匿",
            kakusigamae: "匸",
            kama: "構畑缶釜鎌竃蒲窯冓炯竈窰罐釡鑵",
            kamabisu: "嘩喧噌呶嗷囂聒諠譁讙",
            kamado: "竃爨竈",
            kamasu: "叺鰤",
            kamati: "框",
            ...
            kamu: "齟",
            kamuro: "禿",
            kan: "上間金関官感神館幹監管環観韓完換康患刊巻緩還勧看簡甲慣歓肝喚干甘貫陥寒寛缶艦鑑乾冠勘汗漢菅函斡樺苅侃堪姦憾敢柑桓棺款澗潅竿翰莞諌閑舘串鹸湛亙亘丱凵凾刋勸卷厂咸啣喊圜坎坩奐奸姜嫺嫻宦寰嵌悍愃慳懽戡扞拑捍揀撼旱杆柬栞桿橄樌檻歉歡浣涵淦渙湲灌澣瀚煥煖燗疳癇皖盥眩瞰稈箝篏綸緘繝罐罕羹羮艱莟蒄蚶觀諫讙豢轗遑邯酣鉗銜鐶鑒鑵關陷頷顴餡駻驩骭鬟鰔鰥鸛鹹鼾龕",
            kana: "金神銀愛適奏称悲敵哉哀叶乎恊稱縢諧",
            kanae: "中鼎鬲",
            kanamari: "鋺",
            kaname: "要",
            kanara: "必",
            kanba: "芳樺",
            kane: "金銀兼包錦懐鎌謙鐘矩鉦鍾摂攝釛",
            kanegura: "帑",
            kanezasi: "矩",
            kanga: "考鑑稽攷鑒",
            kani: "蟹蠏",
            ...
            kare: "伊彼渠儂",
            karei: "餉鰔鰈",
            kari: "権仮滑刈狩苅雁猟假甸畋權獵藉鴈鳫",
            karigane: "雁厂鴈鳫",
            karimogari: "殯",
            karizumai: "寓",
            karo: "軽唐藐輕",
            karu: "軽剤苅佻劑嫖輕",
            kasa: "重襲笠傘畳蓋嵩套暈疊疉疂痂疽痒瘍瘡瘻盖葢",
            kasane: "褶",
            kasasagi: "鵲",
            kase: "械稼枷綛",
            kasi: "傾貸柏樫橿槝爨",
            ...
            kasumi: "霞",
            kasuri: "絣綛纃緕",
            kata: "議方交容語難形型固像傾片潟堅硬肩賢剛渕鎌塙淵牢渊糢艱騙",
            katabu: "傾",
            katado: "象",
            katadoru: "貌皃",
            katagata: "旁",
            ...
            kati: "勝徒葛",
            katidoki: "凱",
            katu: "一勝和活割担雄達健合河刈葛恰将功括滑克曽桂巧喝渇褐轄且嘗捷曾筈刮剋劼尅戛戞戡擔拮揩曷歇猾甞瞎磆禊羯聒蛞蝎蠍豁闊濶鞨頡鶻黠",
            katuo: "鰹",
            katura: "葛桂蘰鬘",
            katuri: "和将",
            katute: "曽",
            kau: "耗",
            kawa: "代川交側革河皮煕乾渇逓楊巛晞渝熈獺躱遞銷熙",
            kawagoromo: "裘",
            kawagutu: "鞨",
            kawara: "瓦甎甓磧磚",
            kawarage: "駱",
            ...
            kazika: "鰍鮖",
            kazo: "数數",
            kazu: "一上員万千主数和計量憲昭宗寿嘉葛壱胤壽數萬",
            kazumi: "昭",
            kazunoko: "鯑",
            kazura: "葛鬘",
            kazutori: "籌籤籖",
            ke: "子明化気家外計価消宅花異希恵敬懸仮華慶毛怪圭葵瓜嘩迦塊恢芥稀卦袈祁罫蹴笥亟假價卉咼廨恠愾懈挂旡气氣痂罅膾薊褂襾譁銷閨餉鱠",
            keba: "毳",
            keda: "蓋盖葢",
            kedamono: "獣獸",
            kega: "汚涜溷穢褻黷",
            kegawa: "皮",
            kei: "京経計係警景境形型競系継刑軽契恵掲掛傾敬携慶兄啓鏡径佳圭桂馨卿珪慧憩渓畦稽繋罫茎荊蛍詣頚鶏頃鮭亰偈竸兮冂冏剄勁勍匸哇夐奎奚彑彗徑惠憇憬挂挈攜枅檠溪炯烱煢瓊痙盻眤矜硅磬禊笄絅經綮繼脛莖薊螢袿褂謦谿蹊蹶輕迥逕醯閠閨竟頸髻鴃鷄黥",
            keigamae: "冂",
            keigasira: "彑",
            keki: "隙屐檄覡郤闃鬩鴃鵙",
            kemi: "閲",
            ...
            kemudasi: "窓窗",
            kemuri: "煙烟",
            ken: "見間県権建件検研験監鉄券憲健献険欠遣巻懸勧兼圏堅剣嫌犬肩賢軒玄鎌乾謙顕菅絢鰹萱姦澗串倹倦喧拳捲牽硯絹鍵鹸狽繭丱俔儉劍劔劒剱劵勸卷圈夐妍娟嶮悁惓愆愃慊慳拑掀揀搴暄柬椦權檢歉涓煖狷獻甄痃眷瞼筧箝綣縣繝缺羂腱臉艱蒹虔蛯蜆蜷衒諠謇譴讙豢蹇釼鉗鉉險顯顴騫驗鵑黔",
            kena: "穴",
            kenu: "鑷",
            kenuki: "鑷",
            kera: "螻",
            ...
            keta: "桁",
            keti: "結决劼夬纈頡",
            ketu: "決結欠血穴潔桔傑訣頁蕨亅偈决刔厥囓夬孑抉拮挈杰桀楔歇獗碣竭纈缺羯袂襭覈訐譎蹶闕靹頡鴃齧",
            kewa: "険峨巌峻陀峩峭嵒嶇嶢嶮巖隗險",
            keyaki: "欅",
            kezu: "削創剤刋刪刮劑戮梳",
            ki: "生子決気公期来機記利次企切木聞基空置消規崎起着器帰材極効吉城寄危紀芸喜聴棄樹岐希貴季酒甲埼揮犠己茂雲旗既慶煕黄畿輝亀虫舗奇磯伎机棋毅祈軌鬼宜峡桐刃刀伯肌妃姫葵窺嬉幾忌汽稀徽飢騎妓祇桔杵玖祁乞碕斬訊其揃槻如伐鰭鮪箕亟來倚僖冀决几刄刋剞剪匯匱卉咥唏喟噐圻毀竒奎屎屓嵜幃弃悸愾愧憙截掎揆效斫旡晞暉曁曦朞杞枳棊槎櫃欷欹歸麾气氣沂淇熈熄熹燬犧畸癸皈瞶祺禧稘簣籏綺羈羇羲耆耒聽薊虧蟲覊覬詭諱譏豈跂跪逵鐫鑽鑚雉餽饋饑馗騏驥鮨麒龜熙",
            kiba: "牙",
            kibahen: "牙",
            kibi: "厳黍嚴峭禝稷踵",
            kibisi: "凛凜",
            ...
            kimo: "肝胆膽",
            kimu: "金",
            kin: "金今京公近均禁勤緊筋琴訓堅亀錦菌僅巾斤欣欽禽芹衿襟謹檎亰听噤忻憖懃掀擒槿瑾皸皹矜窘箘箟腱菫衾覲釁鈞釿饉麕黔龜",
            kine: "杵",
            kiniiri: "嬖",
            kinoe: "甲",
            kinoko: "茸蕈",
            ...
            kitana: "汚",
            kiti: "吉詰佶",
            kitu: "切吉詰喫吃桔橘乞迄佶屹愾拮訖譎頡髻",
            kitune: "狐",
            kiwa: "際究谷極窮倪",
            kiwada: "檗蘗",
            kiyo: "清精貴誠聖浄恭圭潔淳澄馨匡瀞廉冽洌淨瀏皎",
            kiyon: "慶",
            kiyosi: "忠圭潔淳靖渙",
            kiza: "兆刻萌剞萠雕",
            kizahasi: "階",
            ...
            kizuna: "紲絆緤縻",
            kko: "児",
            ko: "国東高金子小川来込木古神放戸個去好児呼請史処河庫故超越幸香固康居混樹彦巨拠雇顧己娘湖焦濃黄孤懲肥虚誇粉恋弓桑枯嘘箇堪鋸凝乎姑弧狐糊袴股胡菰虎跨鈷鼓瑚醐乞漉此冴蚕仔樵裾漕壷篭丐个估倨兒冱凅處刳呱哥國壺夸媚峺怙憮戀捏據杞柧桍棹楜沍沽涸滬滸濾炬琥瓠痼瞽箍籠粐罟胯葫虍乕蛄蝴蠱蠶觚詁谺賈踞踰辜逾扈錮餬鴣皷",
            koba: "拒",
            kobako: "筺",
            kobati: "碗",
            kobe: "首",
            ...
            kokoroza: "志",
            kokorozasi: "志",
            koku: "国告石可谷黒刻克穀酷或殻掬鵠剋哭囗圀國尅斛梏槲殼膕轂釛",
            kokubi: "衽袵",
            koma: "細困駒狛齣",
            komaka: "緻",
            komakai: "苛",
            ...
            komono: "厮廝",
            komura: "腓",
            kon: "金今近建根献婚混困懇魂柑欣欽衿坤墾恨昏昆梱痕紺艮壼崑很悃棍棔淦渾溷滾焜狠獻琿緡菎蒟袞褌諢跟轗鯀鯤鰥鶤齦",
            kona: "粉",
            konamoti: "麭",
            konida: "輜",
            kono: "九金近楽好之斯這嗜憙樂",
            ...
            kotowaza: "諺",
            kotu: "骨滑窟糊乞忽惚兀圀榾汨笏鶻",
            kou: "日上行合後高小公区続工校岡向交考広口格神確港構好光河候効江航講興降拡攻皇厚幸抗香康更功弘控孝甲購項豪綱荒鋼較宏浩硬貢鉱黄稿絞穂幌狭恒拘晃紅耕郊剛尻渕峡仰后巧溝衡袷杏蓋鈎撹恰噛亨享怯狗桁佼侯倖勾喉坑垢孔巷庚慌昂杭梗洪糠紘肯肱腔膏酵砿閤鴻劫壕濠轟鵠梱肴皐鮫斯縞糟叩匂虹塙蛤淵釦岬耗亙亘藁亢伉佝倥傚冓冦凰刧匣區吽吭吼咎呷咬哄哽哮啌嚆嚮堽壙夾姜媾嫦寇岫峇峽崗廣很徨恆恍惶慷扣扛拱搆攪撓擴攷效敲杲昊昴晄晧曠昿杠枸栲棡椌槁槓槹歃毫汞洽洸浤渊淆湟溘滉滬烋煌熕爻犒狎狡狹猴甦畊皀皋皎皓盍盖盒睾矼礦磽稾窖箜篁篌篝簧粳絋絳絖絎續纐缸羔羹羮耿肛肓胛胯胱膠芒苟葢蒿薑薨號蚣蛟蝗覯訌詬誥軣逅遑遘鉤鍠鎬鏗鑛閘閧闔陜隍靠頏餃餝鬨鰉鱇鵁鴿鵺黌",
            kouba: "芬",
            kougai: "莱笄",
            koumori: "蝙",
            koumu: "被蒙",
            ...
            kozo: "挙擧舉",
            kozue: "梶梢槙杪槇",
            ku: "日九六子公家区来組工口空宮食球究供久庫苦繰功暮句駆訓貢仁悔奇駒紅呉鳩鈎幾朽汲灸倶狗玖矩躯駈喰袴勾垢咋酌腫韮釦于佝來傴刳劬區吁吼啖啗嘔竒崋嶇廾徠怐惧懼戮抒摎斟枸柧栩毆煦瞿窶箜絎耒苟蒟衢詬鉤韭颶餔驅齲",
            kuba: "配",
            kubi: "首頚縊跟踵頸",
            kubiha: "刎",
            kubikase: "箝鉗",
            ...
            kunu: "功",
            kunugi: "橡栩椢椚櫟檪櫪",
            kura: "車比庫蔵倉夢暗較闇鞍晦昏咋餐沌昧冥蒙儚竸梦峅廩杳暝曖曚溟眩眛瞑矇祚藏黯",
            kurai: "位蔑",
            kuran: "蔵",
            kurasi: "蔵",
            kurawa: "啖",
            ...
            kyaku: "格客却脚隙卻硅謔郤钁",
            kyan: "侠",
            kyo: "挙去許居巨拠拒距虚据嘘渠鋸裾倨墟據擧舉欅歔炬秬筥苣踞遽醵鉅",
            kyoku: "局極曲旭亟勗棘洫膕蕀跼閾馘髷",
            kyou: "京経教強協続校共境況供響橋競興香恐敬孝胸郷驚脅兄叫狭鏡脇凶峡恭狂亮袷杏旺馨橿恰叶窮亨享侠僑兇匡卿喬彊怯挟矯蕎饗暁茎佼梗劫頃匝頬亰僥僵兢竸冂冏况刧匈嚮囂夾姜嬌峽廾徼恟恊慊戮抂拱挾撓曉框梟橇歙洶炯烱烋狡狹畊疆皀皎矜磽穹窖竅筐筺筴篋經繦續羌膠莢莖薑蛩蛬蛟襁誑趙跫躬轎鋏鍄陜鞏竟餃驕驍",
            kyu: "究久喜",
            kyuu: "九求宮球急究久休給旧及級救吸亀丘泣弓鳩臼厩鞠仇朽汲灸窮笈糾僑玖韮咎嗅岌廐廏恷摎柩樛歙毬烋疚皀穹糺繆翕舅舊苙蚯裘貅赳躬逑邱韭鬮龜",
            kyuura: "厳",
            ...
            mako: "真誠眞",
            makomo: "菰蒋",
            makoto: "一実理信真良周慎誠賢丹淳胆亮允紳諦惇諒實忱恂愨洵眞詢",
            makotoni: "実涼諒凉寔",
            maku: "幕膜捲蒔莫摸寞幔繃",
            makura: "枕",
            mama: "海継畑侭儘圸墹壗盡繼",
            ...
            maru: "円団丸圓團圜摶",
            marui: "肱欒",
            masa: "大政方全当理公成勝多和正容応真幹優存将順甲充雅誠仁賢昌聖剛庄祥征晶稚祐允款匡傑暢柾愈諒倭夛將橸當眞",
            masaka: "作",
            masakari: "戉鉞",
            masaki: "柾",
            masame: "柾",
            ...
            maziwaru: "参參爻",
            mazu: "貧",
            me: "五明目米海売女馬妻免眼銘芽雌召牝匁瑪碼聘辟",
            meawa: "娶",
            mebae: "萌萠",
            mebaru: "鮴",
            medogi: "筴筮蓍",
            meetoru: "米",
            megu: "愛恵巡芽斡廻匝寵匯圜徼恤惠紆繞繚輾遶邏",
            megumi: "愛恩潤慈",
            megumu: "萠",
            meguru: "流",
            mei: "明名命盟迷鳴銘謎冥姪暝溟瞑茗螟酩",
            mekake: "妾",
            mekki: "鍍",
            meku: "捲",
            mekura: "盲瞎",
            ...
            meziri: "眥眦",
            mezura: "珍奇竒珎瑰",
            mi: "三五生見民明実務海水利省男参宮神果規農身美視造味観望光深満江未薬皇績臨恵君純看顧御充診己湖臣微聖魅覧銘弥毅珠澄妃稔溢盈塞爾蛇桃眉巳箕實寳已麼弭彌滿瀰睥睹瞰瞿瞻矚縻胥茉覩覽觀躬靡黴",
            mida: "乱淫撹擾妄濫亂婬攪撓溷猥紜紊",
            midara: "姦",
            midare: "婬",
            midari: "淫猥",
            ...
            mit: "三",
            mitamaya: "寝廟寢",
            miti: "行方通実理治道導真路達満陸途康充慶至往倫径芳亨享實廸徃徑甼衢蹊迪逕闡陌隧",
            mitibi: "導",
            mito: "認",
            mitu: "三円道水参光満密弘充慎貢晃弥瑞苗允盈舜蜜參實樒櫁",
            mitugu: "諠",
            miturou: "蝋",
            mituru: "満暢",
            miu: "苗",
            ...
            mizuti: "鮫蛟",
            mizuumi: "湖",
            mo: "三方百最持文面木真門若守望母模盛馬輪燃茂喪毛添漏妹姥洩裳畝藻莫溌萌摸姆媽麼捩揉泄畆糢萠謨",
            moda: "黙悶懣默",
            modae: "悶",
            modo: "戻擬",
            moe: "萌",
            ...
            motii: "餅餠",
            motinoki: "橿",
            moto: "大本東下意産元資求職始木基幹質森旧紀素許源順宗智須礎亙亘剌夲孕很忤悖愎狠舊覓貭邀",
            motodori: "髻",
            motoi: "基",
            motomu: "須",
            motoo: "回廻囘",
            ...
            mottomo: "尢",
            motu: "持物没沒縺",
            mou: "生設申望亡網毛忙帽猛盲卯詣摸妄孟耗蒙儲儚惘旄曚朦檬濛瑁矇网罔耄艨芒莽蠎蟒髦魍",
            mouke: "儲",
            mousen: "氈",
            moya: "舫霏靄",
            moyaibune: "舫",
            ...
            mozi: "綟",
            mozu: "鴃鵙",
            mu: "生六務産向無武陸浮群夢茂慶虫謀蒸牟矛霧畝剥撫蕪鉾睦鵡厶噎嘸梦无旡毋烝畆眸羣鵐鶩",
            mugi: "麦麥",
            mugiko: "麺麪",
            mugo: "惨慘",
            mugura: "葎",
            ...
            muduka: "難",
            myaku: "脈獏脉覓貊貘",
            myou: "明名命妙苗茅廟錨冥孟暝甍眇瞑緲茗螟",
            myuu: "謬",
            n: "金武",
            na: "長生八方七今名成和女向済投無流農南難字並奈亡為樹納稲阿慣鳴穴菜那泣葦萎嘗凪薙馴楠撫做儺哭啾啼嚶娜拏拿拊捫梛涕濟爲狃狎甞痿竝糯綯舐褻齏韲",
            naba: "生",
            nabe: "辺鍋銚邊邉鎬鐺",
            nabebuta: "亠",
            nabi: "並靡",
            ...
            nanzi: "爾而汝乃廼尓迺",
            nanzo: "那烏渠胡奚怎曷瑕盍遐",
            nao: "治作成直有真順温巨忠尚猶仍犹矗胖",
            nara: "対効並均習楢倣伉傚嫺嫻對并效狃竝肄駢",
            narabu: "双儷雙",
            nare: "汝",
            naresika: "麋",
            nari: "業百体成済形城就芸為斉鳴也礼尚稔爲",
            naru: "成徳鳴稔",
            nasa: "情",
            nasi: "梨莫勿无旡",
            nata: "方屶鉈",
            ...
            nazu: "懐",
            nazuna: "薺",
            ne: "十人年合子値音根婦練称寝眠峰稔如禰祢捻峯嶺煉錬寐寢捏捩柢殕袮",
            neba: "粘黏",
            nebu: "舐",
            neesan: "姐",
            nega: "願覦",
            ...
            nezukuri: "艮",
            nezumi: "鼠鼡",
            ni: "日二合新入理児逃荷似仁丹煮尼泥餌爾而煎弐迩烹弍于兒尓岻膩貳貮迯邇",
            nibe: "膠",
            nibu: "鈍駑",
            nie: "贄錵",
            niga: "苦",
            ...
            nizyuu: "廿廾",
            nizyuuasi: "廾",
            no: "入野能農乗退述延及伸載之納飲泉布典濃篠咽洩餐呑乃廼埜箆丿乘舒喃嚥抒飮洵熨篦迺饒",
            nobe: "延",
            nobi: "信暢燹",
            nobiru: "蒜",
            nobo: "上登昇躋陞陟隲",
            ...
            noboru: "宣昂升敲陟",
            nobosi: "登",
            nobu: "業円経進信収常展史修延喜伸順宣房充誠至寿陳寛恒宜辰敦靖惟允薫晋暢寅庸亙亘脩頌",
            nobun: "攵",
            noburu: "辰暢",
            nodo: "咽喉吭臙頏",
            noga: "逃遁佚竄迯逋遯",
            ...
            noo: "直",
            nora: "苗",
            nori: "議学度理法経成教知記利統格式研能規義乗真準親展師憲周登織賀紀芸永順則徳儀載昇宣令功敬宗智裕孝慎仙典律雅哲範訓至祝仁礼賢寿穂倫寛祈宜敦尭矩糊孔詔暢勅禎乃凖笵經藝",
            noro: "呪咒詛麕",
            norosi: "烽燧",
            noru: "駕",
            nosi: "師熨",
            ...
            notto: "則節浬",
            nottoru: "糢",
            nou: "直能応農脳王納悩濃嚢膿儂惱曩瑙碯腦衲",
            nouzuru: "脳腦",
            nozo: "望除臨希覗莅覘",
            nozoku: "窺",
            nozomi: "希",
            nu: "野抜脱貫怒塗縫忽挺擢奴濡孥拔搴渟繹耨褪",
            nue: "鵺",
            nugu: "拭揩",
            nui: "縫",
            nuitori: "繍黹",
            ...
            omori: "権錘權",
            omote: "表面",
            on: "音園雄遠温飲奥御隠恩穏闇蔭厭怨苑薗鴛牡吽慍飮瘟穩薀袁褞諳隱鰮鰛",
            ona: "同女翁",
            onagazaru: "禺",
            onamomi: "葹",
            onara: "屁",
            ...
            orosi: "卸颪",
            oroti: "蠎蟒",
            osa: "長治収修蔵圧押略乱納抑按厭酋摂綜孟乂亂佰壓尹扼攝撥收斂熨畧穉筬脩艾藏釐",
            osae: "鎮鎭",
            osaka: "刑",
            osamu: "理修紀攻順磨靖乃脩",
            osana: "幼",
            ...
            otto: "夫",
            otu: "越乙榲膃",
            ou: "大相区近応横央欧王玉皇圧押奥桜往黄殴鷹姶逢厭凹旺翁襖鴬鴎鴨匡扇邑凰區嘔嚶墺壓夭奧媼嫗尢徃怏懊應拗枉櫻歐殃毆汪泱泓澳燠狎瓮甌甕秧罌膺蓊謳鏖鞅鴦鶯鸚黌",
            ougi: "扇",
            ougo: "朸",
            oumu: "概",
            ouna: "媼嫗",
            ...
            pondo: "听磅",
            ppana: "放",
            ra: "原村楽英良等乱願荒柄羅螺裸蘭喇罹拉瘰薇蘿蠡邏鑼騾",
            rai: "来頼塁瀬洗礼雷狸莱來儡壘徠懶擂櫑瘰癘癩磊禮籟罍耒莉蕾藾蠡貍賚醴",
            raisuki: "耒",
            raki: "滝",
            rakkyou: "薤",
            raku: "楽落絡洛酪擽樂烙犖珞駱",
            ran: "乱卵覧嵐欄濫藍蘭漣亂儖婪嬾巒懍懶攬欒欖瀾燗爛籃繿纜羝襤襴覽醂鑾闌鸞",
            ras: "拉",
            rati: "埒埓",
            ratu: "剌喇埒埓拉溂糲辣",
            rau: "劉",
            re: "連列令礼伶玲禮黎",
            rehu: "猟獵",
            rei: "例冷戻令齢鈴礼黄励零涙霊祈蛎砺伶嶺怜玲苓隷麗儷冽勵唳囹捩櫺泪洌澪犂犁癘礪禮糲綟羚聆茘莅莉藜蛉蠣蠡醴隸靈驪鱧鴒黎齡龕",
            reidukuri: "隶",
            reki: "歴暦擽櫟檪櫪瀝癧礫轢轣靂鬲",
            rekki: "歴",
            ren: "連練恋鎌怜廉憐漣煉簾聯蓮錬匳嗹奩戀攣斂楝歛濂瀲縺聨臉臠茘賺輦鏈鰊",
            renzi: "櫺",
            retu: "列律裂劣烈冽唳埒埓捩洌",
            ri: "人合理成利美離裏里荷梨栗李履亥浬鯉抄狸哩莱吏璃痢裡麗俚俐悧罹漓犂犁籬茘莅莉蜊蠡詈貍釐驪黎黐",
            rie: "江",
            rii: "力利",
            riki: "力働仂篥",
            riku: "六陸勠戮淕蓼",
            rin: "林輪臨鈴隣倫綾厘淋燐琳鱗麟侖凛吝廩悋懍棆淪痳稟禀綸罧菻藺襴躙躪鄰醂釐霖凜",
            riri: "入",
            rissinben: "心",
            riti: "律篥",
            rittoru: "立",
            ritu: "立率律栗葎慄篥",
            riu: "竜",
            ro: "事路郎納露炉朗芦虜鷺櫨蕗侶呂魯櫓賂婁廬枦梠櫚滷濾瀘爐盧粐絽膂臚艢艪艫舮蘆褸輅轤鑢鑪鈩閭顱驢髏鱸鹵",
            roku: "六働録鹿陸緑漉麓禄肋仂戮淕碌祿轆勒",
            ron: "論乱亂侖崙崘淪",
            roo: "郎",
            rotu: "六",
            rou: "労郎良蔵老桜露竜龍朗浪漏糧滝廊摺瀧稜婁弄楼榔牢狼篭聾蝋僂勞咾哢喨壟拉撩撈朖朧柆楞槞樓櫟檪潦琅瑯瓏瘻癆窶籠簍粮縷臘臈莨薐蘢螂螻褸踉醪鏤鑞陋隴",
            rousoku: "蝋",
            ru: "十流路児留塁屡蕗劉琉瑠婁弄篭僂嚠榴璢畄瘤瘻窶籠簍縷螻褸鏤鰡",
            rugi: "動",
            rui: "類塁涙累壘泪瘰縲羸耒莅誄",
            rumata: "殳",
            ruri: "瑠",
            ...
            ruuburu: "留畄",
            ryaku: "略掠擽畧",
            ryo: "良旅慮虜侶涼呂廬梠櫚濾絽膂臚鑢閭驢",
            ryoku: "力働緑仂朸",
            ryou: "料領両郎量良療僚漁養令了菱貞竜龍糧霊亮寮陵綾杏椋掠凌梁涼猟瞭稜諒遼伶嶺怜玲苓倆兩凉喨壟寥崚廖撩撈暸楞榴櫺燎獵簗粱粮繆繚羚聊聆蔆蓼裲踉輛輌鐐隴靈鬣魎鷯",
            ryu: "龍嶐鉚",
            ryuku: "働仂",
            ryuu: "生立流留隆柳竜龍笠粒劉溜琉硫瑠嚠戮旒榴毓游澑瀏犂犁璢畄瘤窿苙鏐霤餾鰡",
            ...
            sagi: "鷺匂",
            sagu: "探",
            sai: "三最西済際税切歳井裁再崎財細材催採殺債妻載災祭埼斎斉菜彩栽柴哉宰才砕紫叉塞采犀砦碕晒偲靭凄殆蓑倅伜儕嵜崔截搓摧擠寨樶洒淬淒滓濟灑犲猜眥眦砌碎齋篩簑簔綵縡纔腮臍萃萋蔡豺戝賽齎躋釵隹雜霽靫靱齏韲顋骰鰓齊",
            saina: "苛嘖",
            saiwa: "幸倖禎禄祚祺祿禧釐",
            saka: "下作阪境早積盛逆坂栄酒賢祥圻垠榮櫑",
            sakadaru: "罍",
            sakaduki: "尽盡",
            sakae: "栄昌",
            sakai: "境堺畍疆",
            ...
            sake: "号酒叫鮭喊嘖嚆號",
            sakenotukasa: "酋",
            saki: "前東先崎幸埼往輝咲笹碕尖岬嵜徃曩",
            sakibarai: "蹕",
            sakigake: "魁",
            sakini: "嚮",
            sakka: "目属",
            sako: "迫浴硲逧",
            saku: "作数策昨削索冊錯咋搾朔柵窄酢雀遡捉乍做册劈嘖愬拆數柞槊溯炸筴筰簀胙薊醋鑿齪",
            sakura: "桜櫻",
            sakusa: "咋",
            sama: "様樣",
            samata: "妨碍礙",
            ...
            samu: "寒凄淒皚",
            samurai: "士侍",
            san: "三山産参算残様散賛杉操酸尽寒傘惨柵撒桟燦珊纂蚕讃餐斬撰蒜刪參簒孱嶄巉彡慘懺懴戔攅棧槧汕潺潸爨疝盞盡竄簪粲繖纉纔芟蔘蠶衫讒讚贊跚鏨鑽鑚閂霰饌驂",
            sana: "真實眞",
            sanada: "絛",
            sanagi: "蛹",
            sanbongawa: "川",
            ...
            sate: "偖扠扨",
            sati: "幸祥祐薩禎",
            sato: "前理知解識達央覚恵里智誠哲郷仁啓賢聖諭悟暁慧聡吏怜喩嶷怱惺曉聰覺觧閭黠",
            satoi: "智敏慧",
            satoru: "理知解識了智哲勘暁慧聡學",
            satosi: "省説恵智哲敏訓啓賢聖慧詔聡怜聰",
            satoukibi: "蔗",
            satu: "五察札殺撮刷冊擦作早幸粟薩拶薩撒靭册刹剳囃扎箚紮靫靱颯",
            satuka: "目",
            satuki: "皐皋",
            sawa: "川沢早障触騒澤猿爽噪觸譟躁醂隰騷",
            sawaga: "閙騷鬧",
            sawan: "沢",
            sawara: "椹鰆",
            saya: "明清鞘莢",
            ...
            sazoya: "嘸",
            sazu: "授",
            se: "所戦数世勢施谷競清責攻背迫瀬稲兄聖妹堰灘咳畝脊竸丗數灑畆眥眦訶誅誚謫蹙",
            seba: "狭狹",
            sebone: "呂膂",
            segare: "倅伜悴忰",
            seguku: "跼",
            sei: "政生制性成正世西済省歳情井勢製声整請青清盛静精背星瀬剤晴誠斉牲聖浄征蒸姓誓靖甥芹犀鯖錆汐鉦凄棲栖逝醒脆脊栴瀞畷婿貰丼倩儕劑丗嘶壻彁彗悽惺掣撕擠旌晟晢橇毳洒淨淒濟猩眥眦睛砌穽筬筮聟聲腥臍萋菁薺蛻蜻贅齎躋霽靜齏韲齊",
            seisyu: "鹹",
            seki: "関石席積赤責績跡折夕潟析籍舎釈昔堰寂隻惜咳汐尺錫戚斥脊蹟碩勣喘拆晰槭淅炙瘠皙碵磧簀腋舍蓆藉蜥螫裼跖蹐蹙蹠迹釋鉐關髢鶺齣",
            sekku: "石",
            seko: "迫逧",
            seku: "齪",
            sema: "迫狭窄拶逼狹褊遒逎阨陋陜隘齪",
            ...
            semi: "蝉蜩",
            semusi: "佝傴瘻駝",
            sen: "選山千川戦先線専船鮮占宣染泉薦仙銭浅洗繊潜釧践茜串鹸桟斬蝉尖扇撰栓栴煎煽旋穿箭羨腺舛詮賎遷銑閃禅膳揃苫鱒亘亶仟倩僉僊僭僣刋剪簒吮喘塹嬋孅專尠孱巛彡悛戔戰拈摶擅擶旃暹栫棧槧槫殲殱氈沾洒涎淺湶潺潛濳澹濺燹牋甎疝痊癬盞瞻磚禪笘筌筅箋簽籤籖綫纖纎羶翦臉舩芟荐蘚蟾譖譛譫賤贍跣踐銓銛錢鐫閂闡阡陝雋霰韆顫餞饌",
            senti: "珊糎",
            sentiguramu: "甅",
            sentimeetoru: "糎",
            sentirittoru: "竰",
            ...
            seri: "芹糴糶",
            seti: "節刹緤",
            setu: "設切説接殺折節雪瀬洩屑脆拙摂窃鱈刹卩啜截掣攝晢椄楔毳泄浙渫竊紲絏緤膤薛褻鑷鞨",
            seu: "尠憔",
            sewa: "忙",
            si: "十市四自後新七子治氏思強支指知初資信次使始住示死私止石士施視試仕守姿紙史師林清司占締志執之染誌酒宗閉刺祉茨己芝敷茂至歯是也矢絞旨枝糸詩滋脚姉諮飼柴凍磯孜紫肢脂詞梓飴夷柿祇欣此嵯匙晒仔伺嗣屍斯獅賜雌侍蒔宍偲笥只弛痴漬砥覗髭巳吏亊侈俟卮厠厮厶呰咨咫啻嗜嗤嘴址塒孳尸屎妛岻巵帋幟廁廝弑徙恣恃懋揣摯撕朿枳梔檮殞沚沁泗滓滲熾瓷畤疵痣癡眥眦祀祠祗稠竢笶篩粢絲緇縒翅耆耜肆舐苡茲葆葹蓍蚩觜誣謚諡豕貲贄齎趾趺輜釶錙閇阯駟駛鮨鯔鰓鰤鴟鵄鷙齒",
            siawa: "幸倖",
            siba: "芝柴縛",
            sibara: "暫頃",
            sibaraku: "姑",
            ...
            simoyasiki: "墅",
            simu: "占俾",
            sin: "新進心信参神身真親審申深請振針森清津伸震普慎診侵寝臣沈浸辛辰宍唇娠晋榛疹秦紳芯薪訊賑矧槙枕僭僣參呻哂嗔宸寢岑忱怎愼抻斟晉晨椹沁滲瀋甄畛眞瞋箴簪縉脣臻蓁蔘蓼蕈蜃袗襯譖譛讖贐軫酳鍼鐔駸鷆鷏齔槇",
            sina: "信品科姿階級葦萎靭撓粃綽靫靱",
            sinaya: "嫋",
            sine: "稲",
            sinigamae: "歹",
            ...
            sitomi: "蔀",
            sitone: "茵蓐衽袵褥",
            situ: "実質室失執湿櫛七叱嫉悉漆疾膝蛭嘯實桎濕瑟虱蝨蟋貭躾隲隰",
            situke: "躾",
            siwa: "吝皴皺襞",
            siwabu: "咳",
            siwabuki: "咳謦",
            ...
            sizi: "榻",
            sizimi: "蜆",
            sizu: "静沈没鎮靖賎湛填汨沒淪湮湎賤鎭靜",
            sizuka: "禅禪謐闃靜",
            sizuku: "雫滴",
            so: "十生組初反夫訴想早殺左素削狙染草措宗沿曽礎祖添庄征阻磯逸疎粗荘姐且杵鋤噌塑岨曾楚疏租蘇遡鼠惣其柘剃疋俎做剔咀囎徂怎愬柤梳泝沮涅溯爼甦疽砠祚胥胙苴蔬蘓蛆詛踈酥麁鼡齟",
            soba: "側傍蕎岨",
            sobada: "屹峙崛欹",
            sobame: "妾",
            sobi: "聳",
            ...
            soko: "損底椢",
            sokona: "残損殘",
            soku: "数側職足速則測息束促即粟塞燭趨戚捉仄喞嗾嗽惻數昃熄矚簇鏃齪",
            soma: "仙杣",
            some: "染",
            somu: "背舛伐叛乖韋",
            son: "成村存損尊孫噂餐遜巽樽鱒忖拵栫洒蹲邨齔",
            sona: "備供具膳饌",
            sone: "嫉妬",
            sono: "園彼苑爾厥囿尓茆",
            soo: "宗",
            ...
            soto: "外",
            sotu: "率卒倅伜卆埣猝",
            sou: "十三生相総世送争想早捜走蔵装将倉層繰創草葬奏宗贈操窓騒双喪曽箱奨庄掃巣桑僧壮槽荘遭滝鯵粟甥竃甑捷蒋鞘諏噌曾叢爽宋匝惣挿掻曹槍漕燥痩糟綜聡蒼藻鎗霜瀧蛸爪葱蚤湊薮偬冏剏剿勦匆卅丗雙叟哈嗾嗽噪囃壯奘奬妝娵嫂孀將崢帚廂弉怱愡愴憔懆找抓搜掫插搶棕椶棗樔歃淙滄溲漱澡炒爭爿牀猩獎瘡稍窗竈笊笙箒箏筝簇籔粽總聰臧艙艘艚艸莊菷蔟薔藪藏裝諍譟贓賍赱蹌踪躁輳銷錚鏘鐺霎颯騷髞鬆鮹鰺鰤",
            soukou: "艸",
            sourou: "候",
            souzite: "惣",
            soyogu: "戦戰",
            sozoroni: "坐",
            su: "日月子代主数総首西済直統住空州過助守好周素角為棄吸捨窓透酸釈刷寿須摩巣陶磨妹擦珠洲据菅澄寸隙漉朱鋤笥諏酢崇雛摺棲栖蘇叢綜剃簾鷲吮呷壽娵拗捐掏搨擂數梳樔歙漱澂濟爲窗笊箝簀總耡芻蒭蘓醋釋饐鬚麈",
            subaru: "昴",
            sube: "全総術滑凡渾總辷",
            subekara: "須",
            subesi: "須",
            ...
            sugu: "勝直優傑駿儁儻杰雋",
            suguru: "英豪俊卓",
            sui: "出水推塁剤吹穂遂垂炊衰酔瑞氷帥睡粋翠錐錘誰椎劑埀壘夊崔彗悴忰惴捶揣榱燧瘁祟穗邃粹綏翆隋膵萃雖觜醉陲隧隹騅",
            suinyou: "夊",
            suka: "賺",
            suke: "相資佐助右介賃裕典昌哉輔祐亮允丞弼甫佑",
            suki: "次銭鍬隙鋤犂犁罅耒耜耡耨釁銛錢",
            suko: "少健",
            sukobu: "頗",
            sukosi: "毫",
            suku: "済少城宿救句粛掬匡淑丞抔拯樔濟竦肅贍",
            sukumo: "粭糘",
            sukumomusi: "蝎",
            sukuna: "尠",
            suma: "澂",
            ...
            susi: "鮓鮨",
            suso: "裾裔",
            susu: "進薦勧奨澄晋膳濯煤侑勸啜嗽奬廸慂慫晉歃洒漱獎迪邁陟",
            susuki: "薄芒",
            susume: "羞",
            susumi: "晋迪",
            susumu: "将奏晋侑迪",
            ...
            suzume: "雀",
            suzuri: "硯",
            sya: "社者車予左写射砂捨謝舎釈卸煮斜姐些叉沙裟赦紗遮柘這貰豫偖冩嗟奢娑寫洒瀉灑炙畭舍苴莎蔗藉赭鉈鯊鷓麝",
            syabe: "喋",
            syaga: "嗄躑",
            syake: "鮭",
            syako: "積",
            syaku: "石赤借釈昔錯勺尺杓灼爵酌錫雀蹟勣呎嚼妁斫晰爍癪皙笏筰綽芍蜥迹釋鑠鵲齣",
            syamo: "鶤",
            syan: "上",
            syao: "小",
            syati: "鯱",
            syatihoko: "鯱",
            syo: "所野書初松処署諸狙緒曙暑庶疎且杵黍渚薯藷恕鋤岨楚疏鼠埜疋舒俎處咀墅嶼抒杼沮爼疽砠絮胥苴蔗蔬蛆蜍詛踈雎鼡齟",
            syoku: "続職食色織植属触飾殖粟嘱埴拭燭蝕厠喞囑嗇寔屬廁惻昃昵矚禝稙稷穡續薔蜀觸謖贖軾餝",
            syou: "政上生相小性勝正省井少商消証乗松声象様請賞青接登渉障清従装将昭精償傷昇焼星招創扱秀承訟症称章笑唱紹衝床照焦昌沼詳聖咲奨尚庄彰祥篠匠晶粧鐘姓荘翔甥且挟鍬甑鯖錆腫升召哨嘗妾娼宵廠抄掌捷梢樟樵湘硝礁肖菖蒋蕉裳詔醤鉦鍾鞘丞摺摂噌槍鎗蛸憧橡瀞秤丼从倡剏剿劭勦厰燮嘯囁囎墻奬妝將峭嶂庠廂從悚悄愀慫慴慯慵憔懾拯挾搶攝敞旌枩杪枌椒椄楫樅樣橦檣歃歙殤浹淞湫漿瀟炒烝燒爿牀牆猖猩獎璋甞瘡瘴睫睛稍稱竦笙筱箏筝簫聳聲聶腥舂艘艟艢莊菁蕭薔蚣裝襄褶觴誦誚諍證踵蹌蹤踪逍邵鈔銷鏘陞霄霎韶頌顳餉驤驫鬆鮹鱆鱶鷦",
            syouhen: "爿",
            syouzyou: "猩",
            syu: "手主取最数首輸株種守修周衆捜酒秀趣須殊掃狩珠酬鰍朱腫呪鍾諏枢趨痩鋳撞柊侏咒娵娶戍搜數棕椶樞橦殳洙溲繻聚茱蛛鄒銖銹鑄鬆鬚鰌麈",
            syuku: "宿縮祝粛粥蹴叔夙淑俶槭倏矗鬻肅菽蓿謖蹙齪",
            syun: "春旬俊瞬淳峻竣舜駿醇訊惇遁馴隼儁吮墫徇恂悛惷洵浚濬皴筍笋荀蓴蕣蠢詢諄蹲逡雋駲鰆鶉",
            syutu: "出率卒卆恤朮蟀齣",
            syuu: "主集州終収修周秋衆捜週就習羽執昇秀宗襲渋祝寿湿拾洲臭舟酬萩穐鰍鍬呪囚愁繍蒐讐蹴輯酋醜什厨嵩摺痩袖鋳楢柊葺揖鷲叟咒售啾嗽壽夂娵岫帚廚愀慴搜掫收楸楫泅湫溲漱澁澀濕甃皺龝箒籀綉緝羞聚脩艘芻菘菷蒭蓚螽褶讎躊遒逎鄒銹鏥鑄陬隰鞦駲驟鰌齪",
            syuuto: "姑舅",
            syuutome: "姑",
            ...
            tabura: "誑",
            tabusa: "髻",
            tada: "三政内理正直真質督伊縄弾忠斉聖征唯宰惟祇糾匡只但禎董飭啻尹彈爛糜糺繩貭",
            tadasi: "理公正規義真督端雅忠貞侃匡矩旦禎肇",
            tadasu: "紀匡擶",
            tadatini: "径徑逕",
            tadayo: "漂汎漾",
            tade: "蓼",
            ...
            tagui: "双雙疇畴",
            tahu: "椨",
            tai: "大対代体当来平台態待太退隊逮替帯貸滞袋泰耐怠敦夷碓秦汰堆岱戴胎腿苔黛鯛醍鎚梯諦殆來兌對帶擡抬棣歹滯炬玳紿臺蒂蔕薹蛻褪詒詆豸躰軆鐓隶靆頽颱駘體",
            taimai: "玳",
            taira: "平坦砥",
            taka: "学高京公挙考能応宅太好登延就将竹貴隆宇敬宗顧孝誉臣岳賢聖尊剛尚卓廷銘宜鷹享喬尭昂峻崇嵩琢寶岌崛巍敞杲陟魏堯",
            takaburu: "亢",
            takadono: "楼樓",
            takamu: "崇",
            takamura: "篁",
            ...
            takanna: "筍笋",
            takara: "用財宝珍寶寳珎貲",
            takasi: "大長天岐貴隆節敬孝律丘尚卓享喬尭昂皐峻崇嵩巍敞髞",
            takatuki: "鐙",
            take: "長全和建宅武雄健竹敬豪誉威岳丈尊剛毅穀猛傑虎嵩茸彪斌孟嶽蕈赳",
            takeki: "彪",
            taken: "武岳",
            takenawa: "酣闌",
            takenoko: "筍笋",
            takeru: "猛",
            takesi: "武健豪威剛毅猛彪孟壯悍洸赳驍",
            taki: "滝瀧嶽瀑",
            takigi: "薪掫蕘",
            tako: "凧蛸鮹鱆",
            taku: "度沢宅択託卓拓巧澤啄托濯琢鐸擢詫倬啅戳拆擇柝棹櫂炸磔謫躅鈬魄",
            takuma: "逞",
            takumi: "工巧匠倆",
            takuwa: "貯蓄儲薀",
            tama: "球環給玉弾霊偶圭魂珠瑞堪玖珪賜錫碧溜玲彈澑瑰瑶璧瓊賚靈魄瑤",
            tamago: "卵孚",
            tamaki: "環鐶",
            tamamono: "賚",
            tamari: "溜澑",
            ...
            tamotu: "維",
            tamusi: "癬",
            tan: "田反担谷段単短探端弾炭誕丹淡壇嘆胆唐灘堪騨但坦旦歎湛箪綻耽蛋鍛檀椴丼亶啖啗單壜彈彖怛愽慱憚憺擔揣摶攤槫檐殫毯湍潭澹猯疸痰眈站簟緞罎膽葮蕁蜒蜑袒襌褝覃譚譫貪賺赧鄲酖鐔靼餤",
            tana: "店棚屶廛",
            tanagokoro: "掬掌",
            tane: "種胤稙",
            tani: "谷澗渓壑峪溪谿",
            ...
            tegata: "劵",
            teguruma: "輦",
            tei: "定体第提庁低程丁締聴停底庭滞袋弟抵邸貞帝廷訂亭堤艇鵜醍綴偵剃呈悌挺梯汀碇禎諦蹄逓鄭釘鼎砥薙畷俤剔叮啼嚔嚏奠姨幀廳廰掟柢梃棣楴洟涕渟滯牴疔眤睇羝蒂蔕蟶裼觝詆躰軆逞遉遞酊酲錣霆騁體髢",
            tekase: "梏",
            teki: "的摘適敵荻杓嫡擢滴笛鏑俶剔廸彳擲滌狄糴覿躑迪逖",
            teko: "杆杠桿梃槓",
            ten: "一出点店転展伝天典殿添淀蚕騨辿佃填纏甜貼顛澱槙丶傳甸唸囀壥奠巓廛忝恬掾畋椽殄沾癜癲碾篆簟纒腆蠶覘諂貂躔輾轉鈿銛霑靦鷆鷏點槇",
            tenmado: "窓窗",
            tenohira: "掌",
            tera: "寺衒",
            tero: "得",
            teru: "両映光央昭栄曜照旭輝晃瑛暁暉皓",
            tesuri: "欄檻闌",
            teti: "綴",
            tetu: "鉄達撤哲徹",
            tetu: "綴轍迭畷姪佚咥啜鉄哲徹垤屮捏耋跌軼輟銕錣鐵鐡餮",
            tetun: "哲",
            ti: "十五市地内千治都和知置質形値津丁散池遅血致盤智徴乳刃恥稚刀茅些陀弛痴蜘馳砥薙仟夂癡眞穉笞緻耻胝褫豸貭踟躓輊遲雉魑黐黹",
            tibi: "禿",
            tidi: "縮",
            tidori: "鵆",
            tiga: "違",
            ...
            timaki: "粽",
            timata: "巷",
            tin: "清丁賃沈珍陳鎮椿亭砧疹塵湛朕填枕戡抻椹狆珎碪趁酖鍖鎭闖鴆",
            tina: "因",
            tinba: "跛",
            tinomigo: "孩孺",
            tinu: "釁",
            ...
            titu: "秩窒蛭姪帙膣腟蟄鷙",
            tiya: "茶",
            to: "十人時問度取外名勝都利解藤止土石研夫説戸頭渡門音捕訪階融吉登図博飛採富津豊等留永徒途執停鳥闘閉撮臣仁泊遂跳溶刃塗刀冨翔兜采訊摂綴兎吐堵妬屠斗杜菟賭鍍砥砺涛釆樋熔兔咤圖抖搴攝搏攬斛梳樢畄當睹礪秉緘聘肚荼莵蚪蠹蠧覩觧跿遏銷鎔鐺鑠閇闍",
            tobari: "幌帳帷幄幃幎",
            tobi: "飛鳶鴟鵄鵈",
            tobira: "扉闔",
            tobiranoto: "戸",
            ...
            tokage: "蜥",
            toke: "解",
            toki: "時言信常説秋斎辰穐鴇晨齋龝閧鬨鴾",
            toko: "所常床",
            tokoro: "所処處攸",
            tokosibari: "輹",
            toku: "得特独督読徳釈竺啄匿涜禿篤悳慝牘犢獨竇纛讀釋陟髑黷",
            toma: "苫篷",
            tomari: "泊",
            tomasu: "斗",
            tomata: "攴",
            tome: "留",
            tomi: "福富智臣冨頓",
            tomo: "大公作和知点共朝基視与供友具紀興幸伴智誠丈那倫寛灯珠奉乏允倶悌禎塘燈寅巴朋侶呂舳艢艫舮鞆點",
            tomoduna: "纜",
            tomoe: "巴",
            tomogara: "輩曹們儕儔",
            tomona: "伴",
            ...
            toro: "蕩瀞盪蘯銷鑠",
            tose: "歳",
            tosi: "年明要世利福歳好史健紀厳順載齢季功敬宗智俊敏寿鋭毅哉稔慧淑峻駿聡惇肇甫禄壽彗齡",
            tosikatu: "寿",
            tosiyori: "耋",
            tote: "迚",
            totemo: "迚",
            ...
            toyo: "豊樋豐",
            toza: "鎖",
            tu: "四子連通都水点告次付土着注積接摘突司津就継塚詰奥衝徹即尽鶴亜拓釣悉漬柘吊貼兎吐妬菟撞附葎亞偸兔兪剪憑抓搶搗擣攣椄痙盡綉繼纉舂莅莵薀蘊誥踵鉉顆鶇鶫點",
            tuba: "椿唾鍔鐔",
            tubaki: "椿唾沫",
            tubakura: "燕",
            tubakuro: "燕",
            ...
            tugi: "調次族亜胤嗣",
            tugomori: "晦",
            tugu: "二続次維承紹序亜尋胤嗣噤拑續鉗韶頌",
            tugumi: "鶇鶫",
            tuguna: "償",
            tui: "対立費終追築序遂叙堆墜椎槌鎚潰對敍敘縋隧",
            tuiba: "啄喋",
            tuide: "序叙敍敘",
            tuini: "卒卆訖竟",
            tuitati: "朔",
            tuka: "事発家支使労仕捕司塚遣束柄尽疲倦掴杷埠亊冢劬勞壟憊憑拏拿攫瘁發羸閊",
            tukae: "痞",
            tukai: "徭",
            tukasa: "務台司嗣曹宦臺",
            tukasado: "司",
            ...
            tyaku: "役着著嫡箸擲磔謫躇",
            tyan: "頭荘莊",
            tyo: "著緒貯樗瀦猪苧屠箸儲佇墸杼楮潴竚紵豬躇迢",
            tyoku: "直勅捗飭敕矗稙躅陟隲",
            tyou: "長場調町重朝提張庁条登超丁聴塚鳥兆徴敏挑潮懲帳彫跳頂釣畳澄敦恰杓鯛樗凋喋寵帖弔暢牒眺脹腸蝶諜銚蔦吊挺釘貼肇傭仗佻冢剳嘲塲姚幀廳廰悵掉掟昶晁條梃樢沾渫漲澂甼疊疉疂疔稠窕笘箚糴糶聽膓萇蜩褶誂貂趙輒輙迢陦雕髫鬯鰈齠",
            tyouzame: "鰉",
            tyu: "厨酎丶廚蛛誅躊",
            tyun: "仲椿",
            tyutu: "朮黜",
            tyuu: "中住注沖仲駐忠柱昼宙虫抽丑厨痩衷註酎鋳紬肘紐偸儔冑冲廚惆晝狆疇畴稠籌籀紂綢胄舳蟄蟲誅躊鈕鍮鑄",
            u: "生産保受売府得打有武防優守失請討撃右友芸羽植雨浮遊宇承布埋御雅熟綿憂祐芋烏迂卯鵜碓瓜苑餓飢享饗倦胡蒔椎笛菟膿伐佑于侑傴夘吁售嗚塢嫗孳抃挌挧掫搨搏擣擽桙沽燠盂磑碾禹糴紆茹藝謳賈賣餒饉饑齲",
            uba: "奪姥簒姆褫",
            ubu: "生産幼",
            ude: "腕",
            udewa: "釧",
            ...
            uzura: "鶉",
            uzutaka: "堆",
            wa: "十二大分発方話和際別割早葉環花訪丸久弁速波破羽王輪房盤我華把娃蛙劃窪詑杷琶磐沸湧涌倭鷲詫佗侘辨辧哇啝夥夬洶滕濆瓣窩苡萵辯鐚鐶靡",
            wabi: "詫佗侘",
            wadakama: "蟠",
            wadako: "和",
            wadati: "轍",
            ...
            yakigari: "焚",
            yakko: "奴",
            yaku: "約役益薬訳躍疫灼亦厄喊奕扼櫟檪籥繹葯藥譯軛鑰阨隘龠",
            yakusyo: "庁廨廳廰",
            yama: "山岾疚",
            yamadori: "翰",
            yamaguwa: "柘",
            ...
            yasina: "養飴豢",
            yasiro: "社廟",
            yasu: "保和安育楽易休健康彦恵裕妥慶仁寿泰那祥芳恭鳩奉靖烈宴匡秦賎坦悌寧又庸倭恬綏賤",
            yasura: "恬",
            yasuri: "鑢",
            yasusi: "保健康純泰恭靖欣悌寧",
            yat: "八",
            ...
            yaya: "稍",
            yaziri: "鏑鏃",
            yo: "四上代米世予止能由夫与葉良好洋呼夜吉寄除読余因善避拠陽依預誉隠訓嘉弥酔詠於寓乎撚輿羊蓉豫仍倚凭丗咏憑搓據攀歟淤畭籀綯縒譱臾舁與蕷誦譽讀醉閼隱靠飫餘饒馮",
            yobina: "号號",
            yoboru: "伸",
            yobu: "呼",
            yodare: "涎",
            ...
            yoro: "寄宜鎧蹌蹣",
            yoroi: "鎧冑",
            yoroko: "喜歓慶煕悦欣僖兌忻怡憙懌懽歡熈驩熙",
            yorozu: "万萬",
            yoru: "夜仍仗",
            yose: "寄",
            yosi: "新理意成勝和元次福領能由義可美優愛英良好洋吉憲伊賀喜幸香順善徳儀彦栄貴宣功純敬宗孝充雅哲快慶克至仁兄啓昌詳泰嘉剛祥芳芦悦佳宜恭圭桂巧祐亮惟允艶馨巌欣欽芹薫慈叔淑膳悌禎如寧彬甫睦麗禄巖譱艷葭萬蘆",
            yosimi: "美嘉誼媾",
            yosoo: "装扮妝裝",
            yosuga: "縁",
            yot: "四",
            ...
            yotu: "四",
            yotugi: "胄",
            you: "八用要容領応葉様洋雄養栄陽曜揚揺桜腰菜幼踊擁溶鷹謡瑛厭桶暢銚蝿湧涌猷傭妖庸楊熔窯羊耀蓉遥沃丿佻佯俑咬壅夭姚孕幺廱徭徼怏恙慂慵應拗揄搖杳昜暎暘曄榮榕樣櫻殀殃漾瀁煬燿犹瑶瓔珱甬痒瘍癢癰穃窈窕窰纓罌膺臾蛹蠅謠踰踴邀酊酩醺鎔雍霙靨鞅頌飫魘鱶鷂鸚遙瑤",
            youhen: "幺",
            youyaku: "稍",
            yowa: "齢弱歯嬬孱懦羸齒齡",
            yowai: "歳歯脆齒",
            yozi: "捩",
            yu: "行百世結有輸由優与雄友油幸温遊裕夕揺露往宙湯諭唯猶弓癒憂逝愉愈佑悠揖柚湧涌侑兪喩彌徃徂揄搖楡渝瑜疣瘉肬腴臾茹萸蕕蝓覦諛踰逾邁閖雍鼬",
            yubi: "指",
            yubukuro: "韜",
            yuda: "委",
            yudame: "弼檠",
            ...
            yuka: "床牀",
            yukari: "縁紫",
            yuki: "行千元世展歩介将維喜志幸順徳之敬雪祥征恭亨晋靭如侑夊裄",
            yuku: "行之",
            yukuha: "的",
            yume: "夢梦",
            yumi: "歩之弓",
            ...
            yuta: "豊寛豐",
            yutaka: "豊温裕浩泰寛穣穰胖饒",
            yuu: "結有由夫優雄融右友油熊遊郵裕誘夕諭勇猶輔憂祐郁厭酉楢鮪又尤愉佑宥幽悠揖柚湧涌猷邑侑俑囮囿岫悒拗揄攸梍游犹疣肬莠蕕蚰蛔蝣迪釉黝鼬",
            yuumesi: "餔",
            yuwai: "祝",
            yuzu: "譲禅遜柚禪讓",
            yuzuri: "譲",
            ...
            zaku: "雀",
            zakuro: "榴",
            zan: "残暫惨斬鱒塹嶄巉慙慚懺懴槧殘竄纔讒鏨",
            zaru: "猿笊",
            zatu: "雑襍雜",
            ze: "慮是膳",
            zei: "税勢説城泉脆噬橇毳筮蚋蛻",
            zeki: "関",
            zen: "前全然善泉銭斬蝉賎漸禅繕膳楠冉喘懦禪譱苒蠕襌褝賤髯",
            zeni: "銭湶錢",
            zenisasi: "緡繦",
            zenmai: "薇",
            zero: "零",
            zeti: "鞨",
            zetu: "絶舌蚋",
            zi: "二人出事自時地治道持次示路仕良字値児除寺締辞遅樹染智茨似仁滋耳寿磁芽稚餌茅侍慈爾璽痔而蒔甚陀馳弐迩冶亊弍兒塒壽孳尓岻峙怩恃珥畤穉膩臑茲貳貮轜辭邇雉",
            zii: "爺",
            zika: "直",
            zikara: "力",
            ziki: "直食境喰寔",
            ziku: "軸竺宍柚忸肭舳衄衂",
            zime: "占",
            zin: "人神志陣臣仁尽沈珍尋刃辰鎮妊稔荏塵壬甚腎訊迅靭侭仞仭儘儿刄姙恁椹潯潭燼盡糂荵蕈蕁衽袵靫靱",
            zine: "笹",
            zinkou: "樒櫁",
            ziretta: "懊",
            zirusi: "印",
            ...
            zoi: "添",
            zoki: "位",
            zoku: "続族財属俗粟賊嗾屬簇續蔟蜀戝鏃",
            zome: "染",
            zon: "存",
            zono: "園薗",
            zore: "嵐",
            zou: "三増藤造象蔵雑像贈臓曽篠曾曹憎橡慥筱臟臧艢藏襍雜",
            zu: "事手主都集済住頭図津鈴刷尽鶴尋豆擦瑞厨逗杜弗亊圖廚荼荳蚓誦連付積詰漬",
            zubon: "袴",
            zui: "泉随瑞髄蕊惴隋膸蘂蕋隨陏髓",
            zuimusi: "螟",
            duka: "塚使遣疲",
            ...
            zusa: "総總",
            zya: "写邪戯蛇惹耶闍麝",
            zyaku: "着若弱寂廻惹雀柘嫋搦擲瘠簀蒻藉鉐鵲鶸",
            zyan: "雀",
            zyo: "受女助除序徐藷叙恕鋤汝如舒抒敍敘絮耡茹莇",
            zyoi: "高",
            zyoku: "辱濁搦溽縟耨蓐褥",
            zyou: "上生場定成情状常乗門条城盛静縄譲娘丈剰浄壌畳蒸靖尉允嘗丞冗嬢擾杖穣醸錠茸帖牒鄭溺捻肇乘仍仗佻剩塲壤奘嫋嫦嬲嫐孃弉拯掟掾撓攘晟條橈淨滌烝犹甞疊疉疂禳穰絛繞繩聶蕘蟐蟯襄諚讓趙躡遶釀鑷靜饒驤",
            zyu: "入数受住授従就習樹需寿儒呪綬酋雛竪嬬濡鷲从儔咒壽孺從懦戍洳籀臑蠕襦誦豎躊頌",
            zyuku: "塾熟粥孰耨",
            zyun: "準順旬純巡准淳潤盾絢閏循楯殉遵醇惇馴隼凖徇恂洵筍笋荀詢閠鶉",
            zyutu: "術述恤戌朮十",
            zyuu: "十重住従充銃渋寿柔縦拾汁什戎獣瀞廿紐从從忸戉揉澁澀狃獸糅絨絛縱蹂鈕鞣",
            zyuumata: "支"
        },
        l = {},
        o, O;
    var Q = function (C) {
        var e, v, V;
        if (V = l[C]) return V;
        e = C.replace(o, function (x) {
            return l[x][0]
        });
        v = C.replace(O, function (x) {
            return l[x][1]
        });
        return [e, v]
    };
    var _ = function (C) {
        ...
        VirtualKeyboard.IME.show(!e ? X : X.concat((typeof e == 'string') ? I[V] = e.split('') : e));
        return [C, C.length]
    };
    i.processChar = function (C, e) {
        var v, V, x, X, z = VirtualKeyboard.IME,
            Z = /[A-z']/;
        if (C == '\u0008') {
            if (e && (V = e.slice(0, -1))) {
                return _(V)
    ...
    var c = function () {
        var C = [],
            ...
            v = [],
            V = [],
            x, X, z, Z, w, W, s = "n'(?=[aeiouy])|n(?=$|[^yaeiou])|",
            S = "|la|xa|li|xi|lu|xu|le|xe|lo|xo|lya|xya|lyu|xyu|lyo|xyo|ltu|xtu",
            k = /sy|si|zy|zi|dy|di|du|ty|ti|tu|hu/g,
            K = {
                sy: "sh",
                si: "shi",
                zy: "j",
        ...
        I.kadu = "一和";
        I.di = "治痔";
        var E = function (t, T, y) {
            var Y = [x[1] + t, x[2] + T];
            if (x.length > 4) Y.push(x[3] + t, x[4] + T);
            else if (x.length > 3) Y.push(x[3] + T);
            l[X + 'k'] = l[X + 's'] = l[X + 't'] = l[X + 'p'] = l[X + 'c'] = Y;
            y.push(X + 'k(?=k|$)', X + 's(?=s|$)', X + 't(?=ch|t|$)', X + 'c(?=ch|$)', X + 'p(?=p|$)')
        };
        for (var r = 0, R = q.length; r < R; r++) {
            x = q[r];
            X = x[0];
            l[X] = x.slice(1);
            if (X != 'n') {
                ...
                Z = l[z][0];
                l[X] = [x[1] + Z, x[2] + 'ー'];
                if (x.length > 4) l[X].push(x[3] + Z, x[4] + 'ー');
                else if (x.length > 3) l[X].push(x[3] + 'ー');
                e.push(X);
                E(Z + 'っ', 'ーッ', V)
            }
        }
        ...
        l.lyo = l.xyo = ["ょ", "ョ"];
        l.ltu = l.xtu = ["っ", "ッ"];
        o = RegExp(s + v.join("|") + "|" + C.join("|") + S, "g");
        O = RegExp(s + e.join("|") + "|" + v.join("|") + "|" + V.join("|") + "|" + C.join("|") + S, "g");
    };
    c();
};
...
function () {
    ...
    (function () {
        var e, v;
        var V = "ǧwštypsdghȟkl'zžčbnmǦWŠTPSDGH\u021eKLZŽČBNM".split('');
        var x = " [].,<>;:\"?`~1!2@3#4$5%6^7&8*9(0)-_=+\|\u00A0".split('');
        for (v in O) C[v] = [O[v], 0];
        for (v in I) C[v] = [I[v], 1];
        for (v in Q) C[v] = [Q[v], 2];
        for (v in _) C[v] = [_[v], 3];
        for (v in c) C[v] = [c[v], 4];
        for (v in o) {
            for (var e = 0, X = V.length; e < X; e++) C[v + V[e]] = [o[v] + (V[e] == "'" ? "’" : V[e]), 1];
            for (var e = 0, z = x.length; e < z; e++) C[v + x[e]] = [o[v] + x[e], 0]
        }
        for (v in l) {
            for (var e = 0, X = V.length; e < X; e++) if (V[e] != "'") C[v + V[e]] = [l[v] + V[e], 1]
        }
        C['hw'] = ['hw', 2];
        O = I = Q = _ = c = o = null;
        i.remap = C
    })();
    i.charProcessor = function (e, v, V) {
        if (e == '\u0008') {
            if (v.length) {
                return [v.slice(0, -1), v.length - 1]
            }
        } else if (V.caps) {
            return [v + e, 0]
        } else if (/[^A-z'ŋčǧȟšžŊČǦȞŠ]/.test(e)) {
            return C[v + e] || [v + e, 0]
        } else {
            return C[v + e] || [v + e, 1]
        }
...
VirtualKeyboard.addLayoutList({
    ...
    dk: {
        '\\': 'ɛ[Ɛ{ɔ]Ɔ}`̀\'́6̂~̃-̄9̆8̇"̈*̣:̤0̌_̱\\\\'
    }
}, {
    code: 'SQ-AL',
    name: 'Albanian',
    ...
    dk: {
        'ˇ': 'nňcčdďsšlľeěrřtťzžNŇCČDĎSŠLĽEĚRŘTŤZŽ ˇ',
        '^': 'aâiîoôAÂIÎOÔ ^',
        '˘': 'aăAĂ ˘',
        '°': 'uůUŮ °',
        '˛': 'aąeęAĄEĘ ˛',
        '˙': 'zżZŻ ˙',
        '´': 'nńcćyýaásślĺeérŕuúiízźoóNŃCĆYÝAÁSŚLĹEÉRŔUÚIÍZŹOÓ ´',
        '˝': 'uűoőUŰOŐ ˝',
        '¨': 'aäeëuüoöAÄEËUÜOÖ ¨',
        '¸': 'cçsştţCÇSŞTŢ ¸'
    }
    ...
    shift: {
        1: '!@্ৰৰ্জ্ঞত্ৰক্ষশ্ৰ()ঃঋ',
        14: 'ঔঐআঈঊভঙঘধঝঢঞওএঅইউফ',
        33: 'খথছঠ',
        38: 'ঁণ',
        43: 'শষ।য'
    }
    ...
    dk: {
        '\\': 'ɛ[Ɛ{ɔ]Ɔ}ŋvŊVɲxƝX`̀\'́6̂~̃-̄9̆8̇"̈*̣:̤0̌_̱\\\\'
    }
}, {
    code: 'BA-RU',
    name: 'Bashkir',
    ...
    dk: {
        '\\': 'ɛ[Ɛ{ɔ]Ɔ}ɓcƁCɗxƊX`̀\'́6̂~̃-̄9̆8̇"̈*̣:̤0̌_̱\\\\ŋqŊQ'
    }
}, {
    code: 'BCI-CI',
    name: 'Baule',
    ...
    dk: {
        '\\': 'ɛqƐQɔxƆX`̀\'́6̂~̃-̄9̆8̇"̈*̣:̤0̌_̱\\\\'
    }
}, {
    code: 'BE-BY',
    name: 'Belarusian',
    ...
    dk: {
        '^': 'eêuûiîoôaâEÊUÛIÎOÔAÂ ^',
        '¨': 'eëuüiïyÿoöaäEËUÜIÏOÖAÄ ¨',
        '´': 'eéuúiíyýoóaáEÉUÚIÍYÝOÓAÁ ´',
        '`': 'eèuùiìoòaàEÈUÙIÌOÒAÀ `',
        '~': 'nñoõaãNÑOÕAÃ ~'
    }
}, {
    code: 'BEM-ZM',
    ...
    shift: {
        0: '\u200c',
        9: '()ঃঋ|ঔঐআঈঊভঙঘধঝঢঞওএঅইউফঢ়খথছঠ?ঁণ',
        43: 'শষ।য'
    }
}, {
    code: 'BN-IN',
    ...
    shift: {
        0: '~!@#৳%^ঞৎ()_+॥ধঊঈড়ঠঐউইঔফৈৌঅষঢথঘঃঝখং:"যঢ়ছঋভণঙৃঁ?'
    }
}, {
    code: 'BN-BD',
    name: 'Unijoy',
        ...
        this.charProcessor = function (O, Q) {
            if (O == '\u0008') {
                ...
                if (c = I[_]) {
                    ...
                    if (/[ᐤᐨᘁᐢᐡᔈ][syw][aeio]/.test(_)) {
                        c = _.charAt(0) + _.charAt(2);
                        return ([e + (I[c] || l[c]) + {
                            s: 'ᐧ',
                            y: 'ᑉ',
                            w: '='
                    ...
                    if (C = I[O]) return [c + C, 1];
                    else
                    return [e + c + O, 1]
                } else {
                    return [e + Q + (I[O] || l[O] || O), 1]
                }
            }
        }
    }
    ...
    dk: {
        ...
        '~': 'nñaãoõNÑAÃOÕ ~',
        '¨': 'aäeëuüiïyÿoöAÄEËUÜIÏOÖ ¨',
        '´': 'aáeéuúiíyýoóAÁEÉUÚIÍYÝOÓ ´',
    ...
    dk: {
        '^': 'cĉaâhĥjĵgĝsŝwŵeêuûiîyŷoôCĈAÂHĤJĴGĜSŜWŴEÊUÛIÎYŶOÔ ^',
        '¨': 'aäeëuüiïyÿoöAÄEËUÜIÏYŸOÖ ¨',
        '`': 'aàeèuùiìoòAÀEÈUÙIÌOÒ `',
        '~': 'nñaãuũiĩoõNÑAÃUŨIĨOÕ ~'
    }
}, {
    code: 'CE',
    ...
    function () {
        ...
        this.charProcessor = function (o, O) {
            if (o == '\u0008') {
                if (O.length) {
                    return [O.slice(0, -1), O.length - 1]
                }
            } else if (i.test(o)) {
                return I[O + o] || [O + o, 0]
            } else {
                ...
                if (_ = I[Q]) {
                    ...
                    if (c = I[o]) return [_ + c, 1];
                    else
                    return [_ + o, 1]
                } else {
                    return [O + (I[o] || l[o] || o), 1]
                }
            }
        }
    }
    ...
    shift: {
        0: '~!@#$%^&*()_+|QWERTYUIOP{}ASDFGHJKL:"ZXCVBNM<>?'
    },
    'cbk': new
    function () {
        var i = this;
        ...
        (function () {
            var l = "的一是不了人我在有他这中大来上国个到说们为子和你地出道也时年得就那要下以生会自着去之过家学对可她里后小么心多天而能好都然没日于起还发成事只作当想看文无开手十用主行方又如前所本见经头面公同三已老从动两长知民样现分将外但身些与高意进把法此实回二理美点月明其种声全工己话儿者向情部正名定女问力机给等几很业最间新什打便位因重被走电四第门相次东政海口使教西再平真听世气信北少关并内加化由却代军产入先山五太水万市眼体别处总才场师书比住员九笑性通目华报立马命张活难神数件安表原车白应路期叫死常提感金何更反合放做系计或司利受光王果亲界及今京务制解各任至清物台象记边共风战干接它许八特觉望直服毛林题建南度统色字请交爱让认算论百吃义科怎元社术结六功指思非流每青管夫连远资队跟带花快条院变联言权往展该领传近留红治决周保达办运武半候七必城父强步完革深区即求品士转量空甚众技轻程告江语英基派满式李息写呢识极令黄德收脸钱党倒未持取设始版双历越史商千片容研像找友孩站广改议形委早房音火际则首单据导影失拿网香似斯专石若兵弟谁校读志飞观争究包组造落视济喜离虽坐集编宝谈府拉黑且随格尽剑讲布杀微怕母调局根曾准团段终乐切级克精哪官示冲竟乎男举客证苦照注费足尔招群热推晚响称兴待约阳哥惊吗整支古汉突号绝选吧参刊亚复伤类备欢另港势刻星断陈掌农夜般念价脑规底故省妈刚句显消衣陆器确破具居批送泽紧帮线存愿奇害增杨料州节左装易著急久低岁需酒河初游严铁族除份敢胡血企仍投闻斗纪脚右苏标饭云病医阿答土况境软考娘村刀击仅查引朝育续独罗买户护喝朋供责项背余希卫列图室乱刘爷龙咱章席错兄暗创排春须承案忙呼树痛沉啊灵职乡细诉态停印笔夏助福块冷球姑划既质巴致湾演木韦怪围静旁园否副辑采食登够赛米假较姐楼获孙宣穿诗歌速忽堂敌试谢央怀顾验营止姓养丽属景郭依威按恶慢座罪维渐胜藏皇街激异摘角瞧负施模草某银露阵值班层修差味织药馆密亮律习田简免毒归波型屋换救寄帝退洋丝湖睡劳妇伯尼皮祖雄婚康评追哈络店翻环礼跑超叶压占均永烈奖婆赶富兰录画遇顿艺普判源亿素船继尚嘴察雨优您险烟阶担散板钟访妹伸佛限讨临吴摇跳曲练构玩玉犯厂肯协幸挥效齐封温疑肉攻纸策充顶寻宁沙防抓例股卖顺警梦剧善蒙票良范坚端靠杂贵怒稿拍率旧掉啦莫授守油恩积益县哭罢庭窗扬忘午卡雪菜牌牛脱博丈弹洲松坏邓鲜短毕置楚欧略智岛抗妻抱载败枪适虚预睛刺爹纷介括销降鱼奔忍宗盘耳野讯配禁索赵默徒架灯峰状款移爸托洪升伙订毫狐镇床互套旅逃骂输唱靖秘词困泪熟财鬼骨申欲征私舞秋巨迎秀搞丁吸审遍墙朱圣避跃忌桌执悲域晓弄亡桥辈闪隐劲闹恐呀付敬监厅库震材冰醒庆绿腿述徐尊硬额误借纳折售遗暴缺迷鲁探货童缓伟君庄凡危烧彩抢控胸戏篇趣束谓概射课洞麻杯透邮荣懂拥献洗休迫叹狗偷阴汽拜横鼓健厚签丹洛喊蓉轮岸奶淡潮训圆卷释诸妙唯夺逐燕呆测浪抽盖偏阅购途纵耶摸挂航择恨舍拳竹唐誉乘弱检宫仪旗含袁址摆奥番混灭握牙虑召猛宽盛核袋绍补典圈丰雅吉赞茶亦谷稳汇厉届迹雷序寒附鸡遭挑肩忆柔戴惜隔豪诚瑞减播麼针棋竞臂挺操腰狂替梅固伦宋钢诺残延虎迅灾悄岳乔川仇季吹粮聚译珠叔谋础仁损融辆净敏伊仙巧零累享伴荡珍勇末奋胆弃烦糊犹税培抵僧锋乃遥摩坦後眉餐惯凭冠抬碰币启码冒汗俗灰督穷颇倾尖韩贸仿孤飘漫予紫侧沿拔袖梁赏幕壁旦晨纯闭凉扫尤炮碗贴插滚缘寺贝润氏冬扩栏荒哲逼吓堆撞郎俩蓝闲辛镜陪骑蛋促羊宜嘛颜贫幅驻萍污杰扑壮萨刑忧貌狱塞凤孔触恋岂森繁碎津侠隆迟辉狠析缩穴萧怨磨伏辞泥龄径鼻赖仰愤慕俄映询惨麦宿倍粗腾稍截染乌愈岗柳铺涉疾挡奉踏忠伍躲籍努朗箱裁帐兼彼霞猪悉扎劝薄筑俊鞋距侵欣挤媒吐魂洁枝盈阻陷甲郑鸣倘剩颗拖舒惠昏振戒丧焦爬凌慧偶晃桃赤烂骗措页凶泰尸坡勒疗塔尘躺殊慰坛甘咬拒彪炸井崇饮祝汪牢桂尾漂聊撒恰凝矛於宾绪彭肚匆描粉贼乏盾愁斜裂滑斐废寂涌详汤彻玄斤轰奸怜朵佳皆鸟邦扶毁聪辩瓶饿蛇捕搬沈枫舅幽魔琴挣聘弯墓欺悟蒋臣返违亏丢援赫魏耐佩酸盟胖傻绕哼秦屈辱昨瘦暂箭署赴递猜潜鸿绩耀涂割豆闷亭祥励宇泛狼悔搭舰浮牵符肃奴爆姊幼夹邀疯允恼租椅尺侍腐颤扭菲瓦擦辣奏殷埋摔盼吟渡衫跨醉艰掩荷苍旋揭桑仗莲钻宏幻刃峡辽娃凯患障丐衡猫丑涛暖溜锅奈罚拾浓键脉锁邻臭芳垂捉恢姆砍驾恭挨祸曹慈抖泉览澳脏疼铜羞档抛苗惑肥驱窝裤估胞柄阔杜勤舟帽玛撤频禅柯莱堪寸哀熊腹尝敲勃巡盗筹扣池浅柴埃嫁枚稀雕厌瓜寿跌扯董锦鉴刷趋捐傲贯殿拨逊踢赔姿迁黎祭滴袭慌鞭茫逢屠昆柏驶咐植惧纽捷圳牲踪丛漠锐喇乾霍湿睁仔吵悠沟墨串俱陶贡浑赢屁驰棒匹拼恒邪脆糟扮贤饰偿拆缠摄拟滋嘿旨闯贺翠缝饱劫抚挖册叛肖熙炼宪庙碧盒谊储冯唤贪卧翼扰胁跪碑呵甜洒谱莎娜阁庸鹏覆玲侯抹卢碍综丘晕拦燃昌吞嫌狄押舌琳雾曼耻柜摊削戚杆岩喂扔逝诞悬爽崔廷凑痴盆御酷艾唉姥笼颠姻携愧芬穆扇郁掷怔芯鼠纠疆曰傅袍唇稣捧勾牧儒慨筋柱卑咽吨虫绳厨冤涨皱疲赌饶矿畅煤腕喷遣浩翁咨镖屏仲嘻吩棉孟撑炉泄葬搜添遵迪伪兆欠谅炎氛杖瞎钓肠披剥誓赚役泡逆矮吊填嘉烛厦夕衰液薛仆迈齿谨呈昂抄弥渴梯疏耗瞪斥夸蒂剪娶痕弗姚债妥璃掏刹晶衷肤鹿拓卓症糖钦绵哩诱枯歇塑妨豫抑珊棍晋淋悦敦艳玻砸嚷盲辨葛罕矩泳宅贷膀捏颈践脖贾轿脾堡娇浙劣潇赐陀蓄坟颂漏杭茅砖瞬鹤辟渔乖霸襄炒哑浦饼牺滩钉吁锡赠哄铃顽殖鹰蔡催芙彬拚轨哟歉盯硕惹契愚帅惶憾懒姨喘兽陌罩猎嵩盐饥凄喉宴腔翰膝陵蜂逻劈廉裹骄贩绘崖辰涯戈坑遮擒蛮芷堵雇挽眠吻孝泊撕虹叙粹勉竭歪慎棵朴械溪莉斑磕寡循斩掠吕昔郊爵徽磁俯谭鼎拂俺嫂帕嗯冻婉桐骆泼匠艇谦妓菩厕俘毅岭丫畏湘桶嗓煌鲍粒巷帘秃腊仓拐绑啥荐倪瑟廊鸭蜜诊棚掀筒媳纹秒沾庞蹲骚歧艘芝哗亩券趟巾淫谎寞灌篮妄搁侄厢叉俞伐宰瞒宙肿漆怖吾吼侨叠啸罐肆裙泣胀赋熬趁咳愉恳辜肌婴羽躬毙拘叮哇晴谜淮旺逸琼姜呜窜颁薪寨尿颊逮卜昭浸刮宛嘱囊寓驳倡浴咕挪搏蓬晌渠兜喃夷沪贱魄舵晰僵糕裔秩倚塌恍钩嘲傍裕煮乳勿竖惩睹株绣妖讶咖纲胎滨耕嗤舱娱匪鸦胃躁狮砰妮凛龟裸嫣甫窑塘纤宠链拱尹掘坝狭铭淳沐馨潘甩榜渊羡侮卿兀喧履猴枉衬畔凳缅弦畜粞溢搂乞旬缚灿舆雁倦酬韵媚堤攀窃嫩遂澄侦陕陋笨匙沫耸踩酱壶啡碌痒鄙壳贞霉蠢芦胳矣焰脊囚辅账佐僚雀撰耍枕捡涵逗粪朦肝蒸滥筷溃隶烤缸弓潭旷哎峻爪怯茂芒肢稻兔圾喻框缴蹈哨颖菊喀妆淹瓷淀蜡嚼剂逛骤暑襟庐苹晒悼昧拢函胧胶抒乒讽歹旱葡惟拣耿廿桩乙谣坠滞孕诵梳冈肺丸霜汁纱衔腻甸啤坎稼禾愣脂萄捞搅屑伞蝶铸躯稚腥藤陡烫梨哦浆僻坊焉隙淘垮滔酿鹅兹捣栋瑰敞癌缆烁玫诈煞膜焚粘摧疫幢汝毯挫纺朽锤兑辫堕笛觅蔽谐氓蔑沸藉卸熄扁炭慷篷眨譬叨蔬绸婿寥浇乓膏膛琢啪淑叭弊灶醋斌奠屯膨沦缕壤冶暇揉萝翔蛛栗荫讥葱巩粥斋迄帜菌铅贿绒侣锻谴汹敷宵讳锣撼亨淌扛杉燥匀渺碟嵌沃剖姬绰嗦绞轴垒噪蕴邵咋坪佣卵昼憋奎捂煎瞅蚀熔虾谬绅镶聋募垄彦翘趴杏彰阐讼枢崭蒲泻俭橡溶瀑扒琛丌丕丙丞丬乇乍乜乩亍亓亘亟亢亥亳亵亸仂仃仄仉仑仕仝仞仟仡仨仫仳仵伉伎伛伢伣伥伧伫伲伶伺伽佃佑佗佘佚佝佞佟佤佥佧佬佯佰佴佶佻佼佾侃侈侉侏侑侔侗侥侩侪侬俅俎俏俐俑俚俜俟俣俦俨俪俫俳俸俾倌倏倔倜倥倨倩倬倭倮偃偈偌偎偕偬偻偾傀傈傣傥傧傩傺僖僦僬僭僮僳儆儇儋儡兕兖兢兮冀冁冉冕冗冢冥冫冱冼冽凇凋凫凰凵凸凹凼凿刁刂刈刍刎刖删刨刬刭刳刽刿剀剁剃剌剐剔剜剞剡剽剿劁劂劐劓劢劬劭劾勋勐勖勘勚勰勺匈匍匏匐匕匚匝匡匣匦匮匾匿卅卉卒卞卟卣卤卦卩卮卯卺厄厉厍厐厘厝厣厥厩厮厶叁叟叩叱叵叻叼叽吆吏吒吖吝吠吡吣吭吮吱吲呃呋呐呒呓呔呕呖呗呙呛呤呦呱呲呶呷呸呻咀咂咄咆咎咏咒咔咙咚咛咝咣咤咦咧咩咪咫咭咯咴咸咻咿哂哆哉哌哏哐哒哓哔哕哙哚哜哝哞哧哮哳哺哽哿唁唆唏唑唔唛唝唠唡唢唣唧唪唬唰唳唷唼唾唿啁啃啄啉啐啕啖啜啧啬啭啮啴啵啶啷啻啼啾喁喈喋喏喑喔喙喟喱喳喵喹喽喾嗄嗅嗉嗌嗍嗑嗒嗔嗖嗜嗝嗟嗡嗣嗥嗨嗪嗫嗬嗯嗲嗳嗵嗷嗽嗾嘀嘁嘈嘌嘎嘏嘘嘞嘟嘣嘤嘧嘬嘭嘶嘹噌噍噎噔噗噘噙噜噢噤噩噫噬噱噶噻噼嚅嚆嚎嚏嚓嚣嚯囔囗囝囟囡囤囫囱囵囹囿圃圄圉圊圜圩圪圬圭圮圯圹圻坂坌坍坜坞坤坨坩坫坭坯坳坶坷坻坼垃垅垆垌垓垛垠垡垢垣垤垦垧垩垫垭垱垲垴垸埂埏埒埔埕埘埙埚埝埠埤埭埯埴埸埽堀堇堋堍堑堙堞堠堰塄塍塥塬塾墀墁墅墉墒墚墟墩墼壅壑壕壬壸壹夂夔夙夤夥夭夯夼奁奂奄奕奘奚奢妁妃妊妍妒妗妞妣妤妩妪妫妯妲妾姒姗姘姝姣姹娄娅娆娈娉娌娑娓娟娠娣娥娩娲娴娼婀婊婕婢婧婪婳婵婶婷婺媛媪媲媵媸媾嫉嫒嫔嫖嫘嫜嫠嫡嫦嫫嫱嬉嬖嬗嬲嬴嬷孀孑孓孙孚孛孜孢孥孪孬孰孱孳孵孺孽宄宓宕宥宦宸寅寇寐寝寤寮寰尉尕尜尢尥尧尬尴尻屃屉屎屐屙屡屣屦屮屹屺屿岈岌岍岐岑岔岖岘岙岚岜岢岣岫岬岱岵岷岽岿峁峄峋峒峙峣峤峥峦峨峪峭崂崃崄崆崎崛崞崤崦崧崩崮崴崽崾嵇嵊嵋嵘嵚嵛嵝嵫嵬嵯嵴嶂嶙嶝嶷巅巍巛巢巫巯巳巽帆帏帑帔帖帙帚帛帧帱帷帻帼幂幄幌幔幛幞幡幺庀庇庋庑庖庚庠庥庳庵庶庹庾廑廒廓廖廛廨廪廴廾弁弈弋弑弘弛弧弩弪弭弼彀彐彖彗彘彝彡彤彳彷徂徇徉徊徕徘徙徜徨徭徵徼忉忏忐忑忒忖忝忡忤忪忭忮忱忸忻忾忿怂怃怄怅怆怊怍怏怙怛怠怡怦怩怫怵怼怿恁恂恃恕恙恚恝恣恤恧恪恫恬恸恹恺恻恽恿悃悌悍悒悖悚悛悝悫悭悮悯悱悴悸悻惆惋惕惘惚惝惦惫惬惭惮惰惴惺愀愆愍愎愕愠愦愫慊慑慝慵憎憔憝憧憨憩憬憷懈懊懋懑懔懦懵懿戆戊戋戌戍戎戕戗戛戟戡戢戤戥戬戮戯戳戽戾扃扈扉扦扪扳扼抉抟抠抡抨抻抿拄拇拈拊拌拎拗拙拧拭拮拯拴拶拷拽挈挎挚挛挜挝挞挟挠挢挦挲挹捃捅捆捋捌捍捎捝捩捭捱捶捺捻掂掇掊掎掐掖掣掬掭掮掰掳掴掸掺掼掾揄揆揍揎揖揞揠揣揩揪揲揶揸揽揾揿搀搋搌搐搓搔搛搠搡搦搪搴搽搿摁摅摈摒摞摭摹摺撂撄撅撇撖撙撩撬撮撵撷撸撺擀擂擅擎擐擗擘擞擢擤攉攒攘攥攫攮攴攵攸敉敕敖敛敝敫斓斛斟斡斧斫旃旄旆旌旎旒旖旭旮旯旰旸昀昃昊昕昙昝昱昴昵昶昽晁晏晔晖晗晟晡晤晦晷晾暄暌暝暧暨暮暹暾曙曛曜曝曦曩曳曷朊朐朔朕札杈杌杓杞杠杩杪杲杳杵杷杼枇枋枘枞枣枥枧枨枭枰枳枵枷枸柁柃柑柒柘柙柚柝柞柠柢柩柬柰柽柿栀栅栈栉栊栌栎栓栖栝栩栲栳栽栾桀桁桄桅桉桊桎桓桔桕桠桡桢桤桦桧桨桫桴桷梃梆梏梓梗梢梧梭梵梼梾梿棁棂棕棘棠棣棰棱棹棺棼椁椋椎椐椒椟椠椤椭椰椴椹椽椿楂楔楗楝楞楠楣楦楫楮楱楷楸楹榀榄榅榆榇榈榉榍榔榕榘榛榧榨榫榭榱榴榷榻槁槊槌槎槐槔槚槛槟槠槭槲槽槿樊樗樘樟樨樯樱樵樽樾橄橇橐橘橙橛橥橱橹橼檀檄檎檐檑檗檠檩檫檬欤欷欹歃歆歙歼殁殂殃殄殆殇殉殍殒殓殚殛殡殪殳殴毂毋毓毖毗毡毪毳毵毹毽氅氆氇氍氐氕氖氘氙氚氟氡氢氤氦氧氨氩氪氮氯氰氲氽汀汆汊汐汔汕汛汜汞汨汩汰汲汴汶汾沁沂沅沆沌沏沓沔沛沣沤沥沧沩沭沮沱沲沼沽泅泌泐泓泔泖泗泞泠泫泮泯泱泵泶泷泸泺泾洄洇洌洎洙洚洧洫洮洱洳洵洹洼洽浃浈浊浍浏浐浒浔浚浜浞浠浣浯浼涅涎涑涓涔涕涝涞涟涠涡涣涤涧涩涪涫涮涸涿淄淅淆淇淖淙淝淞淠淤淦淬淼渌渍渎渑渖渗渚渝渣渤渥渫渭渲湃湄湍湎湓湔湛湟湫湮溅溆溉溏溘溟溥溧溯溱溲溴溷溺溻溽滁滂滇滏滓滕滗滟滠满滢滤滦滪滹漉漓漕漤漩漪漭漯漱漳漶漾潆潋潍潞潢潦潲潴潸潺潼澈澉澌澍澎澜澡澧澶澹濂濉濑濒濞濠濡濮濯瀚瀛瀣瀵瀹灏灞灬灸灼炀炅炊炔炕炖炙炜炝炫炬炯炱炳炷炻炽烀烃烊烘烙烨烩烬烯烷烹烽焊焐焓焕焖焘焙焯焱煅煊煜煦煨煲煳煴煸煺煽熏熘熠熨熳熵熹燎燔燠燧燮燹爝爨爰爻爿牍牒牖牝牟牡牦牮牯牾牿犀犁犄犊犋犍犏犒犟犬犰犴犷犸狁狃狈狍狎狒狙狝狞狡狨狩狯狰狲狳狴狷狸狺狻猁猃猊猓猕猖猗猝猞猡猢猥猩猬猱猷猸猹猾猿獍獐獒獗獠獬獭獯獾玎玑玖玚玟玢玮玱玳玷玺珀珂珈珉珏珐珑珙珞珥珧珩珰珲琅琉琊琏琐琚琥琦琨琪琬琮琰琵琶瑁瑕瑗瑙瑚瑛瑜瑭瑶瑷瑾璀璁璇璋璎璐璜璞璧璨璩璺瓒瓞瓠瓢瓣瓤瓮瓯瓴瓿甄甍甏甑甓甙甥甬甭甯町甾畀畈畋畎畚畛畦畲畴畸畹畿疃疋疔疖疙疚疝疟疠疡疣疤疥疬疭疮疰疱疳疴疵疸疹疽痂痃痄痈痉痊痍痔痖痘痞痢痣痤痦痧痨痪痫痰痱痹痼痿瘀瘁瘃瘅瘆瘊瘌瘐瘕瘗瘘瘙瘛瘟瘠瘢瘤瘥瘩瘪瘫瘭瘰瘳瘴瘵瘸瘼瘾瘿癀癃癍癔癖癜癞癣癫癯癸皂皈皋皎皑皓皖皙皤皱皲皴皿盂盅盍盎盏盔盥盱盹眄眇眈眍眙眚眢眦眩眬眭眯眵眶眷眸眺睃睇睐睑睚睢睥睦睨睫睬睽睾睿瞀瞄瞆瞌瞍瞑瞟瞠瞢瞥瞩瞰瞳瞵瞻瞽瞿矍矗矜矢矧矫矬矶矸矽矾砀砂砉砌砑砒砗砘砚砜砝砟砣砥砦砧砩砬砭砷砹砺砻砼砾硁硅硇硌硎硐硒硖硗硙硝硪硫硭硷硼碇碉碓碘碚碛碜碡碣碥碱碲碳碴碹碾磅磉磊磋磐磔磙磬磲磴磷磺礁礅礓礞礤礴礻祀祁祃祆祈祉祎祓祗祚祛祜祟祠祢祧祯祷祺禀禄禊禚禧禳禹禺禽秆秉秕秣秤秧秫秭秸秽秾稂稃稆稔稗稞稠稷稹稽穑穗穰穸穹窀窄窆窈窍窎窒窕窖窘窟窠窥窦窨窬窭窳窿竣竦竺竽竿笃笄笆笈笊笋笏笕笙笞笠笤笥笪笫笮笱笳笸笺笾筅筇筌筏筐筘筚筛筜筝筠筢筮筱筲筵筻筼箅箍箐箓箔箕箜箝箢箦箧箨箩箪箫箬箴箸篁篆篌篑篓篙篚篝篡篥篦篪篱篼篾簇簋簌簏簖簟簦簧簪簸簿籀籁籴籼籽粑粕粜粝粟粢粤粱粲粳粼粽糁糅糇糈糌糍糗糙糜糠糨糯糸紊絮絷綦綮縻繇纂纛纟纡纣纥纨纩纫纬纭纮纰纴纶纻纼纾绀绁绂绉绊绋绌绎绐绔绖绗绚绛绠绡绢绤绥绦绨绫绬绮绯绱绲绶绷绹绺绻绽绾缀缁缂缃缄缇缈缉缊缋缌缍缎缏缑缒缔缗缙缛缜缞缟缡缢缣缤缥缦缧缨缪缫缬缭缮缯缰缱缲缳缵缶罂罄罅罔罘罟罡罨罱罴罹罾羁羌羔羚羝羟羧羯羰羲羸羹羼羿翅翊翌翎翕翟翡翥翦翩翮翱翳耄耆耋耒耔耖耘耙耜耠耢耥耦耧耨耩耪耱耵耷耽聂聃聆聍聒聩聱聿肀肄肇肋肓肘肛肜肟肪肫肭肮肱肴肷肼肽肾胂胄胍胗胙胚胛胝胤胥胨胩胪胫胬胭胯胰胱胲胴胺胼脍脎脐脒脓脔脘脞脬脯脲脶腆腈腋腌腑腓腙腚腠腧腩腭腮腱腴腺腼腽膂膈膊膑膘膣膦膪膳膺膻臀臁臃臆臊臌臜臧臬臻臼臾舀舁舂舄舐舔舛舜舡舢舣舨舫舭舯舳舴舶舷舸舻舾艄艉艋艏艚艟艨艮艴艽艿芄芈芊芋芍芎芏芑芗芘芜芟芡芤芥芨芩芪芫芭芮芰芴芸芹芽芾苁苄苇苈苊苋苌苎苑苒苓苔苕苘苛苜苞苟苠苡苣苤苧苫苯苴苷苻茁茄茆茇茈茉茌茎茏茑茔茕茗茚茛茜茧茨茬茭茯茱茳茴茵茸茹茺茼荀荃荆荇荏荑荔荙荚荛荜荞荟荠荤荥荦荧荨荩荪荬荭荮荸荻荼荽莅莆莒莓莘莛莜莞莠莨莩莪莰莳莴莶莸莹莺莼莽菀菁菅菇菏菔菖菘菝菟菠菡菥菪菰菱菸菹菽萁萃萆萋萌萎萏萑萘萜萤萦萱萸萼葆葑葙葚葜葩葫葭葳葵葶葸葺蒇蒈蒉蒌蒎蒗蒜蒡蒯蒴蒹蒺蒽蒿蓁蓊蓍蓐蓑蓓蓖蓟蓠蓣蓥蓦蓰蓼蓿蔂蔌蔓蔗蔚蔟蔫蔷蔸蔹蔺蔻蔼蕃蕈蕉蕊蕖蕙蕞蕤蕨蕰蕲蕹蕺蕻蕾薅薇薏薜薤薨薮薯薰薷薹藁藐藓藕藜藩藻藿蘅蘑蘖蘧蘩蘸蘼虍虏虐虑虔虞虢虬虮虱虺虻虼虿蚁蚂蚊蚋蚌蚍蚓蚕蚜蚝蚣蚤蚧蚨蚩蚪蚬蚯蚰蚱蚴蚵蚶蚺蛀蛄蛆蛉蛊蛎蛏蛐蛑蛔蛘蛙蛞蛟蛤蛩蛭蛰蛱蛲蛳蛴蛸蛹蛾蜀蜃蜇蜈蜉蜊蜍蜒蜓蜕蜗蜘蜚蜞蜢蜣蜥蜩蜮蜱蜴蜷蜻蜾蜿蝇蝈蝉蝌蝎蝓蝗蝙蝠蝣蝤蝥蝮蝰蝴蝻蝼蝽蝾螀螂螃螅螈螋螓螗螟螨螫螬螭螯螳螵螺螽蟀蟆蟊蟋蟏蟑蟒蟓蟛蟠蟥蟪蟮蟹蟾蠃蠊蠓蠕蠖蠛蠡蠲蠹蠼衄衅衍衙衢衩衮衲衽衾衿袂袄袅袆袈袒袜袢袤袯袱袷袼裆裈裉裎裒裘裟裢裣裥裨裰裱裳裴裼裾褂褊褐褒褓褙褚褛褡褥褪褫褰褴褶襁襞襦襻覃觃觇觊觋觌觍觎觏觐觑觖觚觜觞觥觫觯觳訇訚訾詈詹誊謇謦讠讣讦讧讪讫讬讱讴讵讷讹讻诀诂诃诅诇诋诌诎诏诐诒诓诔诖诘诙诛诜诟诠诡诣诤诧诨诩诪诫诬诮诰诲诳诶诹诼诽诿谀谂谄谆谇谌谍谏谑谒谔谕谖谗谘谙谚谛谝谞谟谠谡谤谥谧谩谪谫谮谯谰谲谳谵谶豁豇豉豌豕豚豢豮豳豸豹豺貂貅貉貊貔貘贠贬贮贰贲贳贶贻贽赀赁赂赃赅赆赇赈赉赊赍赎赑赒赓赕赗赘赙赜赝赟赡赣赦赧赪赭赳趄趑趔趱趵趸趺趼趾趿跄跆跋跎跏跖跗跚跛跞跣跤跫跬跶跷跸跹跺跻跽踅踉踊踌踔踝踞踟踣踬踮踯踱踵踹踺踽蹀蹁蹂蹄蹇蹉蹊蹋蹑蹒蹙蹦蹩蹬蹭蹯蹰蹴蹶蹼蹿躅躇躏躐躔躜躞軎轧轩轪轫轭轱轲轳轵轶轷轸轹轺轼轾辀辁辂辄辇辊辋辌辍辎辏辐辒辔辕辖辗辘辙辚迂迓迕迢迤迥迦迨迩迭迮迳迸逄逅逋逍逑逖逞逡逦逭逯逵逶逾遁遄遏遐遑遒遘遛遢遨遴遽邂邃邈邋邑邕邗邙邛邝邡邢邬邯邰邱邳邴邶邸邹邺邾郄郅郇郏郐郓郗郛郜郝郡郢郦郧郫郯郴郸郾鄂鄄鄞鄢鄣鄯鄱鄹酂酃酆酉酊酋酌酎酏酐酗酚酝酞酡酢酣酤酥酦酩酪酮酯酰酲酴酵酶酹酽酾醅醇醌醍醐醑醚醛醢醣醪醭醮醯醴醵醺釉釜銎銮鋈錾鍪鎏鏊鏖鐾鑫钅钆钇钊钋钌钍钎钏钐钑钒钔钕钖钗钘钙钚钛钜钝钞钠钡钣钤钥钧钨钪钫钬钭钮钯钰钲钳钴钵钶钷钸钹钺钼钽钾钿铀铂铄铆铇铈铉铊铋铌铍铎铏铐铑铒铓铔铕铖铗铘铙铚铛铝铞铟铠铡铢铣铤铥铦铧铨铩铪铫铬铮铯铰铱铲铳铴铵铷铹铻铼铽铿锂锃锄锆锇锈锉锊锌锍锎锏锑锒锓锔锕锖锗锘锚锛锜锝锞锟锠锢锥锧锨锩锪锫锬锭锯锰锱锲锳锴锵锶锷锸锹锺锼锽锾锿镀镁镂镃镄镅镆镈镉镊镋镌镍镎镏镐镑镒镓镔镕镗镘镙镚镛镝镞镟镠镡镢镣镤镥镦镧镨镩镪镫镬镭镮镯镰镱镲镳镴镵闩闫闬闰闱闳闵闶闸闺闼闽闾闿阀阂阃阄阆阇阈阉阊阋阌阍阎阏阑阒阓阕阖阗阘阙阚阛阜阝阡阢阪阮阱阼阽陂陇陉陔陛陟陧陨陬陲陴隅隈隋隍隗隘隧隰隳隹隼隽雉雌雍雎雏雒雠雩雯雳雹霁霄霆霈霎霏霓霖霡霪霭霰霹霾靓靛靡靥靳靴靶靼鞅鞍鞑鞒鞔鞘鞠鞣鞫鞯鞲鞴韧韨韪韫韬韭韶顷顸顼颀颃颅颉颋颌颍颎颏颐颒颓颔颕颙颚颛颞颟颡颢颥颦颧飏飐飑飒飓飔飕飖飗飙飚飧飨餍餮饔饕饣饤饦饧饨饩饪饫饬饯饲饳饴饵饷饸饹饺饻饽饾馀馁馂馃馄馅馇馈馉馊馋馌馍馎馏馐馑馒馓馔馕馗馘馥驭驮驯驲驴驵驷驸驹驺驼驽驿骀骁骃骅骇骈骉骊骋骍骎骏骐骒骓骔骕骖骘骙骛骜骝骞骟骠骡骢骣骥骦骧骰骱骶骷骸骺骼髀髁髂髅髋髌髑髓髟髡髦髫髭髯髹髻鬃鬈鬏鬓鬟鬣鬯鬲鬻魁魃魅魇魈魉魍魑鱽鱾鱿鲀鲂鲃鲄鲅鲆鲇鲈鲉鲊鲋鲌鲎鲏鲐鲑鲒鲓鲔鲕鲖鲗鲘鲙鲚鲛鲝鲞鲟鲠鲡鲢鲣鲤鲥鲦鲧鲨鲩鲪鲫鲬鲭鲮鲯鲰鲱鲲鲳鲴鲵鲶鲷鲸鲹鲺鲻鲼鲽鲾鲿鳀鳁鳂鳃鳄鳅鳆鳇鳈鳉鳊鳋鳌鳍鳎鳏鳐鳑鳒鳓鳔鳕鳖鳗鳘鳙鳚鳛鳜鳝鳞鳟鳠鳡鳢鳣鸠鸢鸤鸥鸧鸨鸩鸪鸫鸬鸮鸯鸰鸱鸲鸳鸴鸵鸶鸷鸸鸹鸺鸻鸼鸽鸾鹀鹁鹂鹃鹄鹆鹇鹈鹉鹊鹋鹌鹍鹎鹐鹑鹒鹓鹔鹕鹖鹗鹘鹙鹚鹛鹜鹝鹞鹟鹠鹡鹢鹣鹥鹦鹧鹨鹩鹪鹫鹬鹭鹯鹱鹲鹳鹴鹾麂麇麈麋麒麓麝麟麴麸麽麾黉黍黏黔黛黜黝黟黠黡黢黥黧黩黪黯黹黻黼黾鼋鼍鼐鼗鼙鼢鼬鼯鼷鼹鼽鼾齄齑龀龁龂龃龅龆龇龈龉龊龋龌龚龛龠㑩㔉㖞㛿㟆㧑㧟㨫㱩㱮㲿㶶㻏䁖䅉䇲䌷䌸䌹䌺䌼䌽䌾䍀䍁䓕䗖䙊䙓䜣䜧䞌䞍䞐䩄䯅䲞䴓䴔䴕䴖䴗䴘䴙".split(''),
                ...
                Q = {};
            var _, c, C, e, v, V, x, X, z;
            for (_ = 0, X = o.length; _ < X; _++) {
                v = l[_];
                x = o[_].replace(/./g, function (Z) {
                    return O[Z]
                });
                if (x == '0') continue;
                if (I[x]) I[x].push(v);
                else I[x] = [v];
                for (c = 1, z = x.length; c < z; c++) {
                    C = x.substr(0, c);
                    if (e = Q[C]) {
                        if (e.length < 9 && e[e.length - 1] != v) Q[C].push(v)
                    } else {
                        Q[C] = [v]
                    }
                }
            ...
            for (c in Q) {
                if (I.hasOwnProperty(c)) {
                    if (I[c].length < 10) I[c] = I[c].concat(Q[c].slice(0, 10 - I[c].length))
                } else {
                    I[c] = [].concat(Q[c]);
                }
            }
    ...
    function () {
        ...
        i.activate = function () {
            ...
            l.don = l.dong;
            l.dua = l.duan;
            l.fue = l.fuen = l.fueng;
            l.gon = l.gong;
            l.hon = l.hong;
            l.jio = l.jion = l.jiong;
            l.jua = l.juan;
            l.kon = l.kong;
            l.len = l.leng;
            l.lon = l.long;
            ...
            l.zon = l.zong;
            l.zua = l.zuan;
            VirtualKeyboard.Langs.CN.INPArr = l
        };
        i.charProcessor = VirtualKeyboard.Langs.CN.processChar
    }
}, {
    ...
    alt: {
        0: '~¡ºª¢€ħðþ‘’–×*äåãø˛đłúüö«»á`ß´¨ˇñéíóõæ^çœ˘˚¯¸˙¿'
    },
    shift_alt: {
        1: '¹²³£¥',
        9: '“”—÷',
    ...
    dk: {
        ...
        '*': '~≈c©r®n№d°t™mµp¶.…%‰+±<≤>≥=≠|¦s§',
        '^': 'aâcĉeêgĝhĥiîjĵoôsŝuûwŵyŷzẑáấéếóốàầèềòồãẫẽễõỗAÂCĈEÊGĜHĤIÎJĴOÔSŜUÛWŴYŶZẐÁẤÉẾÓỐÀẦÈỀÒỒÃẪẼỄÕỖ',
        '˘': 'aăeĕgğiĭoŏuŭáắȩḝàằãẵAĂEĔGĞIĬOŎUŬÁẮȨḜÀẰÃẴ',
        '˚': 'aåuůwẘyẙáǻAÅUŮÁǺ',
        '¯': 'aāæǣeēgḡiīoōuūyȳéḗóṓèḕòṑäǟȧǡöȫȯȱǫǭõȭüǖAĀÆǢEĒGḠIĪOŌUŪYȲÉḖÓṒÈḔÒṐÄǞȦǠÖȪȮȰǪǬÕȬÜǕ',
        '¸': 'cçdḑeȩgģhḩkķlļnņrŗsştţćḉĕḝCÇDḐEȨGĢHḨKĶLĻNŅRŖSŞTŢĆḈĔḜ',
        '˙': 'aȧbḃcċdḋeėfḟgġhḣſẛmṁnṅoȯpṗrṙsṡtṫwẇxẋyẏzżśṥšṧāǡōȱAȦBḂCĊDḊEĖFḞGĠHḢIİMṀNṄOȮPṖRṘSṠTṪWẆXẊYẎZŻŚṤŠṦĀǠŌȰiılŀLĿ'
    }
}, {
    code: 'HR',
    name: 'Croatian',
    ...
    dk: {
        '´': 'nńcćzźaásślĺeérŕuúiíyýoóNŃCĆZŹAÁSŚLĹEÉRŔUÚIÍYÝOÓ ´',
        'ˇ': 'nňcčzždďsšlľeěrřtťNŇCČZŽDĎSŠLĽEĚRŘTŤ ˇ',
        '°': 'aåuůAÅUŮ °',
        '¨': 'aäeëuüiïyÿoöAÄEËUÜIÏYŸOÖ ¨',
        '^': 'aâeêuûiîoôAÂEÊUÛIÎOÔ ^'
    }
    ...
    dk: {
        ...
        '´': 'nńcćyýaásślĺeérŕuúiízźoóNŃCĆYÝAÁSŚLĹEÉRŔUÚIÍZŹOÓ ´',
        '˝': 'uűoőUŰOŐ ˝',
        '¨': 'yÿaäeëuüiïoöYŸAÄEËUÜIÏOÖ ¨',
        '¸': 'nņcçgģsşlļkķrŗtţNŅCÇGĢSŞLĻKĶRŖTŢ ¸'
    }
}, {
    code: 'DA-DK',
    name: 'Danish',
    ...
    shift: {
        0: '࿓༪༫༬༭༮༯༰༱༲༳༕࿔༴༸ྊཪཋསྦྱ༂༖ཌདྲྭཫ཮༁སྒྱསྦྲགྲྭFསྤྱསྒྲརྒྱསྐྱསྨྲསྤྲྈསྐྲ༃སྨྱༀཥརྩྭརྐྱཎཊ྅'
    },
    dk: {
        'f': 'ཨྸཝྭལླཡྱརྲཐྠཆྖཛྫཀྐདྡཔྤཅྕཙྩཧྷཏྟཁྑསྶགྒངྔབྦཇྗཟྯཕྥཚྪཞྮཤྴའཱམྨནྣཉྙ༡༏༢༐༣༑༤༒༥༈༦༙༧༘༨༷༩༵༠྄༄༆༅༇ི༎ོ།ེ༼ུ༽་ ࿓~༪!༫@༬#༭$༮%༯^༰&༱*༲(༳)༕ྺ࿔+ྊྻཪྼཋྠཫRཌྜ༖ྰ཮{༁}༴|ཾ"ཥྵཎྞཊྚ྅?༌ ',
        'F': '༄༹༡࿅༢༶༣༓༤ྋ༥༔༦࿈༧࿄༨࿆༩༺༠༻ཝྉ༅༗ལ༞ཡ༛ར༜ཐ༟ཆྃཛ྆ཀ࿃ད࿁པ࿂འ࿀ཅ༾ཨ༿ཧིྀོཽེཻུ྇ྂཁ༉ས༊ག࿐ང࿑བཿཇཾཟ༝ཕ༚ཚ࿏ཞ࿎ཤ྾ཙ྿མ࿉ན࿊ཏ࿋ཉ࿌་ f࿇'
    }
}, {
    code: 'HI-IN',
    ...
    shift: {
        0: 'ऒऍॅ्रर्ज्ञत्रक्षश्र()ःऋऑऔऐआईऊभङघधझढञओएअइउफऱखथछठऎँणऩऴळशष।य़'
    },
    alt: {
        1: '१२३४५६७८९०',
        12: 'ॄ',
    ...
    shift: {
        0: '~!@#$%^&*)(_+|ޤޢޭޜޓޠޫީޯ÷}{ާށޑﷲޣޙޛޚޅ:"ޡޘޝޥޞޏޟ><؟'
    },
    alt: {
        35: ';',
        40: '\u200d\u200c\u200e\u200f,'
    ...
    dk: {
        '\\': 'ɛ[Ɛ{ɔ]Ɔ}ɓvƁVɗxƊXnɲNƝ`̀\'́6̂~̃-̄9̆8̇"̈*̣:̤0̌_̱\\\\ŋqŊQ'
    }
}, {
    code: 'NL',
    name: 'Dutch',
    ...
    shift: {
        0: '༊༄༅༆',
        6: '༈༸༴༼༽ཿ༑ྭྐྑྒྔ྄ྀཻཽྕྖྗྙྟྠྡྣྤྥྦྨྩྪྫྮྯཱྱྲླྴྶྷ'
    },
    alt: {
        0: '࿑1234567890-=\\ྈྉ',
        17: 'ྃ༚༛༜༝༞༟[]ཊཋཌཎ‹›༷ཾ༹;\'༓྾༃༏ཪྊྃཥ,./'
    },
    shift_alt: {
        0: '࿐!@#$%༁&*()_+ྺ',
        17: 'ྂ',
    ...
    caps: {
        0: '࿑1234567890-=\\ྈྉ࿇ྃ༚༛༜༝༞༟[]ཊཋཌཎ‹›༷ཾ༹;\'༓྾༃༏ཪྊཥ,./'
    },
    shift_caps: {
        0: '࿐!@#$%༁&*()_+ྺ',
        17: 'ྂ',
    ...
    dk: {
        '´': 'nńcćzźsśeéoóNŃCĆZŹSŚEÉOÓ ´',
        '`': 'aàeèuùoòAÀEÈUÙOÒ `',
        '^': 'aâgĝeêuûiîAÂGĜEÊUÛIÎ ^',
        'ˇ': 'cčzžsšCČZŽSŠ ˇ',
        '~': 'oõOÕ ~'
    }
}, {
    ...
    'cbk': (function () {
        ...
        var o = function (c) {
            ...
            c = 0;
            if (e[1]) {
                c = (e[1].charCodeAt(0) - 0x1371) * 10
            }
            if (e[2]) {
                c += e[2].charCodeAt(0) - 0x1368
            }
            return c
        };
        var O = function (c, C) {
            ...
            if (c != '00') {
                if ((v = c.charAt(0)) != '0') {
                    e = String.fromCharCode(parseInt(v) + 0x1371);
                }
                if ((v = c.charAt(1)) != '0') {
                    e += String.fromCharCode(parseInt(v) + 0x1368);
                }
                if (e == '፩' && !C) {
                    e = ''
                }
        ...
        var Q = function (c) {
            ...
            if (e) {
                C = 0;
                if (e[1]) C = o(e[2]) * 100000000;
                if (e[3]) C += o(e[4]) * 1000000;
                if (e[5]) C += o(e[6]) * 10000;
                if (e[7]) C += o(e[8]) * 100;
                if (e[9]) C += o(e[9]);
            }
            return C.toString();
        ...
        return {
            activate: function () {
                if (!I) {
                    var c = "'|'1|'2|'3|'4|'5|'6|'7|'8|'9|:፡|_|`|`1|`2|`3|`4|`5|`6|`7|`8|`9|`ህ|`ስ|`ሽ|`ዥ|`ጭ|`ጽ|a|e|i|o|u|ሁi|ህ|ህe|ህi|ህo|ህu|ህህ|ል|ልe|ልi|ልo|ልu|ሕ|ሕe|ሕi|ሕu|ሙe|ሙi|ም|ምe|ምi|ምo|ምu|ሥe|ሥi|ሥu|ር|ርe|ርi|ርo|ርu|ስ|ስe|ስi|ስo|ስu|ስስ|ሽ|ሽe|ሽi|ሽo|ሽu|ሽሽ|ቁi|ቅ|ቅe|ቅi|ቅo|ቅu|ቅይ|ቑe|ቑi|ቕ|ቕe|ቕi|ቕu|ቡe|ቡi|ብ|ብe|ብi|ብo|ብu|ቭ|ቭe|ቭi|ቭu|ት|ትe|ትi|ትo|ትu|ች|ችe|ችi|ችo|ችu|ችች|ኁe|ኁi|ኅe|ኅi|ኅo|ኅu|ን|ንe|ንi|ንo|ንu|ኝ|ኝe|ኝi|ኝo|ኝu|አa|አe|ኢi|ኩe|ኩi|ክ|ክe|ክi|ክo|ክu|ክይ|ኹe|ኹi|ኽ|ኽe|ኽi|ኽu|ኽይ|ው|ውe|ውi|ውo|ዓa|ዝ|ዝe|ዝi|ዝo|ዝu|ዥ|ዥe|ዥi|ዥu|ዥዝ|ዥዥ|ይ|ይe|ይi|ይo|ድ|ድe|ድi|ድo|ድu|ዽ|ዽe|ዽi|ዽo|ዽu|ጅ|ጅe|ጅi|ጅo|ጅu|ጉe|ጉi|ግ|ግe|ግi|ግo|ግu|ግይ|ጙe|ጙi|ጝ|ጝe|ጝi|ጝu|ጥ|ጥe|ጥi|ጥo|ጥu|ጭ|ጭe|ጭi|ጭo|ጭu|ጭች|ጭጭ|ጵ|ጵe|ጵi|ጵo|ጵu|ጽ|ጽe|ጽi|ጽu|ጽስ|ጽጽ|ፅe|ፅi|ፅo|ፉe|ፉi|ፍ|ፍe|ፍi|ፍu|ፑe|ፑi|ፕ|ፕe|ፕi|ፕo|ፕu|፡|፡፡|።፡|፣|፣፣|፤|፧|‹|‹‹|›|››|ⶥe|ⶥi|ⶭe|ⶭi|ⶵe|ⶵi|ⶽe|ⶽi|ⷅe|ⷅi|ⷍe|ⷍi|ⷕe|ⷕi|ⷝe|ⷝi".split('|'),
                        C = "'፩፪፫፬፭፮፯፰፱፠_`፩፪፫፬፭፮፯፰፱ኅሥⶥⶵⶽፅአእኢኦኡኊህሀሂሆሁኅልለሊሎሉሕሐሒሑᎀᎁምመሚሞሙሠሢሡርረሪሮሩስሰሲሶሱሥሽሸሺሾሹⶥቊቅቀቂቆቁⷅቘቚቕቐቒቑᎄᎅብበቢቦቡቭቨቪቩትተቲቶቱችቸቺቾቹⶭኈኊኀኂኆኁንነኒኖኑኝኘኚኞኙዓኧዒኰኲክከኪኮኩⷍዀዂኽኸኺኹⷕውወዊዎዐዝዘዚዞዙዥዠዢዡⶵⶵይየዪዮድደዲዶዱዽዸዺዾዹጅጀጂጆጁጐጒግገጊጎጉⷝⶓⶔጝጘጚጙጥጠጢጦጡጭጨጪጮጩⶽⶽጵጰጲጶጱጽጸጺጹፅፅፀፂፆᎈᎉፍፈፊፉᎌᎍፕፐፒፖፑ፡።:፣፥፤፧‹«›»ⶠⶢⶨⶪⶰⶲⶸⶺⷀⷂⷈⷊⷐⷒⷘⷚ".split(''),
                        e = "ጪeⶺeዺeጚeⶔeሒeኺeዂeⷒeኚeጲeቒeቚeጺeፂeጢeዢeⶲeቢeᎅeⶪeቺeዲeፊeᎉeጊeጒeⷚeሂeኂeኊeጂeኪeኲeⷊeሊeሚeᎁeኒeፒeᎍeቁeቂeቊeⷂeሪeሲeሢeቲeቪeዊeሺeⶢeዪeዚeጨeⶸeዸeጘeⶓeሐeኸeዀeⷐeኘeጰeቐeቘeጸeፀeጠeዠeⶰeበeᎄeⶨeቸeደeፈeᎈeገeጐeⷘeሀeኀeኈeጀeከeኰeⷈeለeመeᎀeነeፐeᎌeቀeⷀeረeሰeሠeተeቨeወeሸeⶠeየeዘeጭaጮaጩaⶽaⶽoⶽuዽaዾaዹaጝaጝoጙaጙuሕaሕoሑaኽaኽoⷕaኹuኹaⷕoⷕuኝaኞaኙaጵaጶaጱaቕaቕoቑaቑuጽaጽoጹaፅaፆaፅuጥaጦaጡaዥaዥoዡaⶵaⶵoⶵuብaቦaቡaቡuⶭaⶭoⶭuችaቹaቾaድaዶaዱaፍaፍoፉaፉuግaጎaጉaጉuⷝaⷝoⷝuህaሆaሁaሁeሁuኅaኆaኁaኁuጅaጆaጁaክaኮaኩaኩuⷍaⷍoⷍuልaሎaሉaምaሞaሙaሙuንaኖaኑaፕaፖaፑaፑuቅaቆaቁaቁuⷅaⷅoⷅuርaሮaሩaስaሶaሱaሥaሥoሡaትaቶaቱaቭaቭoቩaውaዎaውuሽaሾaሹaⶥaⶥoⶥuይaዮaይuዝaዞaዙaዐaእaኢeኧe`eኡu`u`i`aዒe`Eእe`ዕኦo`oኦaቆoኆoኮoጎo«‹»›'!፠፡፤፤፧፧፥፣፡፣፡-፡+፡#_1_2_3_4_5_6_7_8_0__".split(/(?=(?:..)+$)/g),
                        v = "ጬⶼዼጜⶕሔኼዄⷔኜጴቔቜጼፄጤዤⶴቤᎆⶬቼዴፌᎊጌጔⷜሄኄኌጄኬኴⷌሌሜᎂኔፔᎎቈቄቌⷄሬሴሤቴቬዌሼⶤዬዜጬⶼዼጜⶕሔኼዄⷔኜጴቔቜጼፄጤዤⶴቤᎆⶬቼዴፌᎊጌጔⷜሄኄኌጄኬኴⷌሌሜᎂኔፔᎌቄⷄሬሴሤቴቬዌሼⶤዬዜጫⶐጯⶻⶾⶹዻⶍዿጛጞጟⶖሓሖሗኻኾⷓዅዃⷖⷑኛⶉኟጳⶑጷቓቖቛቝጻጾጿፃፇፁጣⶏጧዣዦዧⶳⶶⶱባⶅቧᎇⶫⶮⶩቻቿⶇዳⶌዷፋፎፏᎋጋጏጓጕⷛⷞⷙሃሇኋኈኍኃኇኋኍጃⶎጇካኯኳኵⷋⷎⷉላⶀሏማⶁሟᎃናⶈኗፓⶒፗᎏቃቇቋቍⷃⷆⷁራⶂሯሳⶃሷሣሦሧታⶆቷቫቮቯዋዏዉሻⶄሿⶣⶦⶡያዯዩዛⶋዟኣኣኤእዐዑዑዒዓዔዔዕዕዖዖⶊቈኈኰጐ<>¡:;?,፥፦፠፨᎐᎑᎒᎓᎔᎕᎖᎘᎙_".split('');
                    I = {};
                    l = {};
                    for (var V = 0, x = C.length; V < x; V++) l[c[V]] = C[V];
                    for (var V = 0, X = v.length; V < X; V++) I[e[V]] = v[V];
                    c = C = e = v = null
                }
            },
            charProcessor: function (c, C) {
                var e = C + c,
                    v, V, x = 1;
                if (c == '\u0008') {
                    if (C.length) {
                    ...
                    c = VirtualKeyboard.Langs.ET.conv[c] || c;
                    if (e = l[C + c]) {
                        x = e.length
                    } else if (e = I[C + c]) {
                        x = 0
    ...
    'cbk': function (i, I) {
        ...
        if (i == '\u0008') {
            ...
            i = VirtualKeyboard.Langs.ET.conv[i] || Q[i] || i;
            if (i == ' ') {
                o = '፡'
            } else {
                if (I == '`') {
                    if (/[0-9]/.test(i)) o = '፻፩፪፫፬፭፮፯፰፱'.charAt(i);
                    else if ('`' == i) o = i;
                    else o = I + i
                } else if (I == '~') {
                    if (/[0-9]/.test(i)) o = '፼፲፳፴፵፶፷፸፹፺'.charAt(i);
                    ...
                    l = _[i] || _[i.toLowerCase()];
                    if (isNumber(l) && I) {
                        o = VirtualKeyboard.Langs.ET.cons[I].charAt(l);
                        if (!o || o == ' ') {
                            o = I;
                            O = I.length
                        }
                        ...
                        o = I + i;
                        if ('`' == o || '~' == o) O = 1;
                        else O = VirtualKeyboard.Langs.ET.cons[i] ? 1 : 0
                    }
                }
            }
        }
    ...
    'cbk': function (i, I) {
        ...
        if (i == '\u0008') {
            ...
            i = VirtualKeyboard.Langs.ET.conv[i] || i;
            if (i == ' ') {
                o = '፡'
            } else {
                l = Q[i] || Q[i.toLowerCase()];
                if (isNumber(l)) {
                    if (I) {
                        o = VirtualKeyboard.Langs.ET.cons[I].charAt(l);
                        if (!o || o == ' ') {
                        ...
                        o = VirtualKeyboard.Langs.ET.cons['እ'].charAt(l) || I + i
                    }
                } else {
                    o = I + i;
                    O = VirtualKeyboard.Langs.ET.cons[i] ? 1 : 0
                }
            }
        }
        return [o, O]
    ...
    dk: {
        '\\': '[ɛ{Ɛ]ɔ}ƆəjƎJŋqŊQ`̀\'́6̂~̃-̄9̆8̇"̈*̣:̤0̌_̱\\\\'
    }
}, {
    code: 'FO',
    name: 'Faeroese',
    ...
    dk: {
        '´': 'nńcćzźaásślĺwẃeérŕåǻuúiíyýoóNŃCĆZŹAÁSŚLĹWẂEÉRŔÅǺUÚIÍYÝOÓøǿæǽØǾÆǼ ´',
        '`': 'aàwẁeèuùiìyỳoòAÀWẀEÈUÙIÌYỲOÒ `',
        '¨': 'aäwẅeëuüiïyÿoöAÄWẄEËUÜIÏYŸOÖ ¨',
        '^': 'cĉaâhĥjĵgĝsŝwŵeêuûiîyŷoôCĈAÂHĤJĴGĜSŜWŴEÊUÛIÎYŶOÔ ^',
        '~': 'nñaãuũiĩoõNÑAÃUŨIĨOÕ ~'
    }
}, {
    ...
    dk: {
        '\\': 'ɗ[Ɗ{ɓ]Ɓ}yƴYƳŋVŊv`̀\'́6̂~̃-̄9̆8̇"̈*̣:̤0̌_̱\\\\'
    }
}, {
    code: 'GAA-GH',
    name: 'Ga',
    ...
    dk: {
        '\\': 'ɛ[Ɛ{ɔ]Ɔ}ŋqŊQ`̀\'́6̂~̃-̄9̆8̇"̈*̣:̤0̌_̱\\\\'
    }
}, {
    code: 'EN-IE',
    name: 'Gaelic',
    ...
    dk: {
        '\\': 'ɛ[Ɛ{ɔ]Ɔ}gɣGƔvʋVƲƒjƑJɖcƉCŋqŊQ\\\\`̀\'́6̂~̃-̄9̆8̇"̈*̣:̤0̌_̱'
    }
}, {
    code: 'KA-GE',
    ...
    shift: {
        0: 'ⰚⰇⰛⰌⰪⰫⰥ',
        8: 'ⰊⰙⰩⰠⰟⱜⰡⰞⰅⰓⰕⰟⰉⰖⰉⰑⰒⰣⰆⰀⰔⰄⰗⰃⰝⰋⰍⰎ',
        36: '⁙ⰈⰘⰜⰂⰁⰐⰏⰤⰧⰩ'
    }
}, {
    code: 'GOT-ANCIENT',
    ...
    dk: {
        '^': 'aâeêuûiîoôAÂEÊUÛIÎOÔ ^',
        '´': 'cçaáeéuúiíyýoóCÇAÁEÉUÚIÍYÝOÓ ´',
        '¨': 'aäeëuüiïyÿoöAÄEËUÜIÏYOÖ ¨',
        '`': 'aàeèuùiìoòAÀEÈUÙIÌOÒ `',
        '~': 'nñaãoõNÑAÃOÕ ~'
    }
}, {
    ...
    dk: {
        ...
        '_': '.˘αᾰιῐυῠΑᾸΙῘΥῨ _',
        '=': 'ωὦ.῏αἆηἦιἶυὖΩὮΑἎΗἮΙἾ =',
        '+': 'ωὧ.῟αἇηἧιἷυὗΩὯΑἏΗἯΙἿΥὟ +',
        '½': 'ωᾦαᾆηᾖΩᾮΑᾎΗᾞ ½',
        '῟': 'ωᾧαᾇηᾗΩᾯΑᾏΗᾟ',
        ';': 'ωώ.´αάηήεέιίυύοόΩΏΑΆΗΉΕΈΙΊΥΎΟΌ ;',
        ':': '.¨ιϊυϋΙΪΥΫ :',
        '´': 'ωῴαᾴηῄ',
        '΅': '.΅ιΐυΰ ΅',
        '[': 'ωῶ.῀αᾶηῆιῖυῦ [',
        '{': 'ωῳ.ιαᾳηῃΩῼΑᾼΗῌ {',
        '«': 'ωῷαᾷηῇ «',
        ']': 'ωὼ.`αὰηὴεὲιὶυὺοὸΩῺΑᾺΗῊΕῈΙῚΥῪΟῸ ]',
        '}': '.· }',
        '»': 'ωῲαᾲηῂ »',
        '΄': 'ωώ.΄αάηήεέιίυύοόΩΏΑΆΗΉΕΈΙΊΥΎΟΌ ΄',
        '¨': '.¨ιϊυϋΙΪΥΫ ¨',
        '\'': 'ωὠ.᾿αἀηἠεἐρῤιἰυὐοὀΩὨΑἈΗἨΕἘΙἸΟὈ \'',
        '\"': 'ωὡ.῾αἁηἡεἑρῥιἱυὑοὁΩὩΑἉΗἩΕἙΡῬΙἹΥὙΟὉ "',
        '᾿': 'ωᾠαᾀηᾐΩᾨΑᾈΗᾘ',
        '῾': 'ωᾡαᾁηᾑΩᾩΑᾉΗᾙ',
        '~': '.΅ιΐυΰ ~',
        '`': '.῭ιῒυῢ `',
        '῁': '.῁ιῗυῧ ῁',
        '\\': 'ωὢ.῍αἂηἢεἒιἲυὒοὂΩὪΑἊΗἪΕἚΙἺΟὊ \\',
        '|': 'ωὣ.῝αἃηἣεἓιἳυὓοὃΩὫΑἋΗἫΕἛΙἻΥὛΟὋ |',
        '¬': 'ωᾢαᾂηᾒΩᾪΑᾊΗᾚ ¬',
        '῝': 'ωᾣαᾃηᾓΩᾫΑᾋΗᾛ',
        '/': 'ωὤ.῎αἄηἤεἔιἴυὔοὄΩὬΑἌΗἬΕἜΙἼΟὌ /',
        '?': 'ωὥ.῞αἅηἥεἕιἵυὕοὅΩὭΑἍΗἭΕἝΙἽΥὝΟὍ ?',
        'ι': 'ωᾤαᾄηᾔΩᾬΑᾌΗᾜ',
        '῞': 'ωᾥαᾅηᾕΩᾭΑᾍΗᾝ'
    }
}, {
    ...
    dk: {
        '´': 'nńcćzźaáæǽøǿsślĺwẃeérŕåǻuúiíyýoóNŃCĆZŹAÁÆǼØǾSŚLĹWẂEÉRŔÅǺUÚIÍYÝOÓ ´',
        '`': 'aàwẁeèuùiìyỳoòAÀWẀEÈUÙIÌYỲOÒ `',
        '¨': 'aäwẅeëuüiïyÿoöAÄWẄEËUÜIÏYŸOÖ ¨',
        '^': 'cĉaâhĥjĵgĝsŝwŵeêuûiîyŷoôCĈAÂHĤJĴGĜSŜWŴEÊUÛIÎYŶOÔ ^',
        '~': 'nñaãuũiĩoõNÑAÃUŨIĨOÕ ~'
    ...
    shift: {
        1: 'ઍૅ્રર્જ્ઞત્રક્ષશ્ર()ઃઋઑઔઐઆઈઊભઙઘધઝઢઞઓએઅઇઉફ',
        33: 'ખથછઠ',
        38: 'ઁણ',
        42: 'ળશષ।'
    },
    ...
    dk: {
        '\\': 'ƙ[Ƙ{ɗxƊXɓvƁVƴ]Ƴ}`̀\'́6̂~̃-̄9̆8̇"̈*̣:̤0̌_̱\\\\'
    }
}, {
    code: 'HE-IL',
    ...
    shift: {
        0: 'ְֱֲֳִֵֶַָֺֹֻּֽֿׁׂׅ֤֪֦֥֧֛֑֖֣֮֩֙֒֯֝֠֨ׄ֬֫֟֓֞֜֡֕֔֗֘'
    },
    alt: {
        0: ';',
        2: '̶̊₪\u200d\u200c͏\u200e\u200f◌-•\\̈״€',
    ...
    caps: {
        14: 'QWERTYUIOP',
        26: 'ASDFGHJKL;\'ZXCVBNM,./'
    },
    shift_caps: {
        0: 'ְֱֲֳִֵֶַָֹֻּׁׂ/\'קראטוןםפ[]שדגכעיחלךף',
        37: 'זסבהנמצתץ'
    }
}, {
    code: 'HI-IN',
    ...
    shift: {
        0: '~ऍॅ्रजतकश()रऋ|औऐआईऊभङघधझढञओएअइउफऱखथछठ',
        38: 'ँणVBळशष।य़'
    },
    caps: {
        14: 'औऐआईऊभङघधझ',
    ...
    shift: {
        1: 'ऍॅ्रर्ज्ञत्रक्षश्र()ःऋऑऔऐआईऊभङघधझढञओएअइउफऱखथछठ',
        38: 'ँण',
        42: 'ळशष।य़'
    },
    alt: {
    ...
    dk: {
        'ˇ': 'nňcčdďsšeěrřtťzžNŇCČDĎSŠEĚRŘTŤZŽ ˇ',
        '^': 'aâiîoôAÂIÎOÔ ^',
        '˘': 'aăAĂ ˘',
        '°': 'uůUŮ °',
        '˛': 'aąeęAĄEĘ ˛',
    ...
    alt: {
        1: '!@#$%*&•[]',
        14: 'ᖐᐄᖀᑮᑏᓰᒦᓃᓖᔩ“‘ᖒᐆᖂᑰᑑᓲᒨᓅᓘ…łᖔᐋᖄᑳᑖᓵᒫ',
        46: 'ᔮ'
    },
    shift_alt: {
        0: '~¢®¼½¾^⅔©÷+',
    ...
    alt: {
        1: '!@#$%*&•[]',
        14: 'ᖐᐄᖀᑮᑏᓰᒦᓃᓖᔩ“‘ᖒᐆᖂᑰᑑᓲᒨᓅᓘŋłᖔᐋᖄᑳᑖᓵᒫ',
        46: 'ᔮ'
    },
    shift_alt: {
        0: '~¢®¼½¾^⅔©÷+',
    ...
    dk: {
        ']': 'ᑕᑖᓴᓵᑲᑳᖃᖄᐊᐋᔭᔮᖓᖔᒪᒫᖑᖒᓱᓲᒧᒨᑐᑑᑯᑰᖁᖂᐅᐆᓗᓘᓄᓅᐃᐄᕿᖀᑭᑮᔨᔩᒥᒦᓇᓈᕋᕌᐸᐹᕙᕚᒐᒑᓚᓛᒍᒎᔪᔫᕕᕖᕈᕉᐳᐴᖢᖣᕗᕘᐱᐲᕆᕇᙵᙶ'
    }
}, {
    code: 'IU-IKU',
    ...
    'cbk': VirtualKeyboard.Langs.IPA.charProcessor
}, {
    code: 'EN-IE',
    name: 'Irish',
    normal: '`1234567890-=#qwertyuiop[]asdfghjkl;\'zxcvbnm,./',
    ...
    shift: {
        0: 'ಒ',
        3: '್ರರ್ಜ್ಞತ್ರಕ್ಷಶ್ರ()ಃಋ',
        14: 'ಔಐಆಈಊಭಙಘಧಝಢಞಓಏಅಇಉಫಱಖಥಛಠಎ',
        39: 'ಣ',
        42: 'ಳಶಷ|'
    },
    alt: {
    ...
    shift: {
        0: '»!ៗ"៛%៍័៏()៌=ឭឈឺែឬទួូីៅភឿឧាំៃឌធអះញគឡោះ៉ឍឃជេះពណំុះ៕?'
    },
    alt: {
        0: '\u200d\u200c@៑$€៙៚*{}x៎\\ៜ៝ឯឫឨ',
        21: 'ឦឱឰឩឳ',
    ...
    shift: {
        0: '\u200d!ៗ៊៛័៌៍៏៎៑_+/ឈឺែឬទួូីៅភោះៀៃាំឌធុះះុំគឡ៖៉ឍឃជេះពណំ,.?'
    },
    alt: {
        0: '៙1234567890{}៚*',
        16: 'ឯឫឦ',
    ...
    shift: {
        0: '`ㄲㄺㅈㄿㄾ=""\'~;+\\ㅍㅌㄵㅀㄽ56789%/ㄷㄶㄼㄻㅒ01234"ㅊㅄㅋㄳ?-"\'',
        46: '!'
    },
    'cbk': VirtualKeyboard.Langs.KR.charProcessor
}, {
    ...
    'cbk': VirtualKeyboard.Langs.LA.charProcessor
}, {
    code: 'LO-LAO',
    name: 'Lao SengKeo',
    normal: '@ຢຟໂຖຸູຄຕຈຂຊໍ\\ົໄຳພະິີຣນຍບລັຫກດເ້່າສວງຜປແອຶືທມໃຝ',
    shift: {
        0: '©໑໒໓໔໌ຼ໕໖໗໘໙ໍ່ໝົ້໐້ຳ-+ິ້ີ້ຮ່ຳຽ-/ັ້;.,:໊໋!?%',
        37: '&(ຯໜຶ້ື້ໆ"$)'
    }
}, {
    code: 'LO-LA',
    ...
    shift: {
        0: '\'1234໌ຼ56789ໍ່\\ົ້0*_+ິ້ີ້ຣໜຽ-ຫຼັ້;.,:໊໋!?%=₭(ຯxຶ້ື້ໆໝ$)'
    },
    alt: {
        1: '໑໒໓໔໕໖໗໘໙໐'
    }
    ...
    shift: {
        0: 'ञ्१२३४५६७८९०)ं्ोध्भ्च्त्थ्ग्क्षइएर्ैब्क्म्ँन्ज्व्प्ीस्ूश्ह्ऋख्द्ल्ः?श्ररू'
    },
    alt: {
        1: '1234567890',
        12: '+',
    ...
    dk: {
        '`': 'aàwẁeèuùiìyỳoòAÀWẀEÈUÙIÌYỲOÒ `',
        '´': 'nńcćzźaáøǿæǽsślĺwẃeérŕåǻuúiíyýoóNŃCĆZŹAÁØǾÆǼSŚLĹWẂEÉRŔÅǺUÚIÍYÝOÓ ´',
        '¨': 'aäwẅeëuüiïyÿoöAÄWẄEËUÜIÏYŸOÖ ¨',
        '^': 'cĉaâhĥjĵgĝsŝwŵeêuûiîyŷoôCĈAÂHĤJĴGĜSŜWŴEÊUÛIÎYŶOÔ ^',
        '~': 'nñaãuũiĩoõNÑAÃUŨIĨOÕ ~'
    }
    ...
    shift: {
        0: 'ة![]﴾٪^﴿*()-+ۀؤىړټ',
        20: 'غۍۋ­ظضآشډﭪګحژگﻻ:"ذښثڅﱣڼً«»؟'
    },
    alt: {
        0: 'ّﱣﱠﱢﱟﱡﱞٌُُْٰٔإأآٱًٍَِﻻـ'
    }
}, {
    code: 'FA-IR',
    ...
    dk: {
        '~': 'nńcćxźzżaąsślłeęoóNŃCĆXŹZŻAĄSŚLŁEĘOÓ ~'
    }
}, {
    code: 'PT-BR',
    ...
    dk: {
        '´': 'nńcćzźaásślĺeérŕåǻuúiíoóNŃCĆZŹAÁSŚLĹEÉRŔÅǺUÚIÍOÓøǿæǽwẃyýØǾÆǼWẂYÝ ´',
        '`': 'aàeèuùiìoòAÀEÈUÙIÌOÒwẁyỳWẀYỲ `',
        '¨': 'aäeëuüiïoöAÄEËUÜIÏOÖwẅyÿWẄYŸ ¨',
        '^': 'cĉaâhĥjĵgĝsŝeêuûiîoôCĈAÂHĤJĴGĜSŜEÊUÛIÎOÔwŵyŷWŴYŶ ^',
        '~': 'nñaãuũiĩoõNÑAÃUŨIĨOÕ ~',
    ...
    dk: {
        '`': 'aàeèuùiìoòAÀEÈUÙIÌOÒwẁyỳWẀYỲ `',
        '´': 'nńcćzźaáøǿæǽsślĺeérŕåǻuúiíoóNŃCĆZŹAÁØǾÆǼSŚLĹEÉRŔÅǺUÚIÍOÓwẃyýWẂYÝ ´',
        '¨': 'aäeëuüiïoöAÄEËUÜIÏOÖwẅyÿWẄYŸ ¨',
        '^': 'cĉaâhĥjĵgĝsŝeêuûiîoôCĈAÂHĤJĴGĜSŜEÊUÛIÎOÔwŵyŷWŴYŶ ^',
        '~': 'nñaãuũiĩoõNÑAÃUŨIĨOÕ ~',
        'ˇ': 'nňcčzžhȟgǧdďsšlľkǩeěrřtťNŇCČZŽHȞGǦDĎSŠLĽKǨEĚRŘTŤʒǯƷǮ ˇ'
    ...
    shift: {
        0: 'ॐ॒॑!?\'"<>()_+॥ठढैृथञूीौफॠॡाषधऊघःझखॢ,॰ङईछळभणंऐऔ\u200d'
    },
    alt: {
        0: '॔',
        8: '*[]',
    ...
    dk: {
        '^': 'nɲcɕzʑNƝ^^',
        '`': 'bɓnŋcƈaádɗkƙeépƥtƭyƴoó``BƁNŊCƇAÁDƊKƘEÉPƤTƬYƳOÓ'
    }
}, {
    code: 'SR-SP',
    ...
    shift: {
        0: 'ෙ!@#$%^&*()_+|ූඋැඍඔශඹෂධඡඥ:ෟීෘෆඨ්\u200dයXණඛථ,"ඞඣඪඊභඵළඝ?'
    },
    alt: {
        5: '€',
        11: '¥',
    ...
    shift: {
        0: '̮!̥̊݉♰♱܊»)(«+:ܑܱܴܷܻܾܰܳܶܺܽ݀݁̈̄̇̃݊ـ̤̱̣̰ܸܼܹ݂ܲܵܿ،؛؟'
    },
    alt: {
        0: 'ّ܁܂܃܄܅܈܉܋܌܍┌┐',
        14: 'ًٌَُ̭ٓٔ݇݃݅',
    ...
    shift: {
        0: 'ఒ',
        3: '్ర',
        5: 'జ్ఞత్రక్షశ్ర()ఃఋ',
        14: 'ఔఐఆఈఊభఙఘధఝఢఞఓఏఅఇఉఫఱఖథఛఠఎఁణ',
        42: 'ళశష'
    },
    alt: {
        1: '౧౨౩౪౫౬౭౮౯౦',
    ...
    shift_caps: {
        0: '_ๅ/-ภถุึคตจขชฃๆไำพะัีรนยบลฟหกดเ้่าสวงผปแอิืทมใฝ'
    }
}, {
    code: 'TH',
    ...
    shift_caps: {
        0: '_=๒๓๔๕ู๗๘๙๐๑๖็ตยอร่ดมวแใฌ้ทงกัีานเไขบปลหิคสะจพ'
    }
}, {
    code: 'TH',
    name: 'Thai',
    ...
    dk: {
        '^': 'uûaâeêiîıîoôUÛAÂEÊİÎIÎOÔ ^',
        '¨': 'uüaäeëyÿiïıïoöUÜAÄEËİÏIÏOÖ ¨',
        '~': 'aãnñoõAÃNÑOÕ ~',
        '´': 'uúaáeéiíıíoóUÚAÁEÉİÍIÍOÓ ´',
        '`': 'uùaàeèiìıìoòUÙAÀEÈİÌIÌOÒ `'
    }
}, {
    code: 'TR',
    name: 'Turkish Q',
    ...
    dk: {
        '^': 'aâiîeêuûıîoôAÂİÎEÊUÛIÎOÔ ^',
        '¨': 'aäiïeëuüıïoöAÄİÏEËUÜIÏOÖ ¨',
        '~': 'nñaãoõNÑAÃOÕ ~',
        '´': 'aáiíeéuúıíoóAÁİÍEÉUÚIÍOÓ ´',
        '`': 'aàiìeèuùıìoòAÀİÌEÈUÙIÌOÒ `'
    }
}, {
    code: 'TK',
    ...
    dk: {
        '¨': 'aäwẅeëuüiïyÿoöAÄWẄEËUÜIÏYŸOÖ ¨',
        '^': 'aâwŵeêuûiîyŷoôAÂWŴEÊUÛIÎYŶOÔ ^',
        '´': 'aáwẃeéuúiíyýoóAÁWẂEÉUÚIÍYÝOÓ ´',
        '`': 'aàwẁeèuùiìyỳoòAÀWẀEÈUÙIÌYỲOÒ `',
        '~': 'nñaãoõNÑAÃOÕ ~'
    }
}, {
    ...
    dk: {
        '\"': 'aäeëiïoöuüwẅyÿAÄEËIÏOÖUÜWẄYŸ "',
        '^': 'aâeêiîoôuûwŵyŷAÂEÊIÎOÔUÛWŴYŶ ^',
        '\'': 'aáeéiíoóuúyýwẃcçCÇAÁEÉIÍOÓUÚYÝWẂ \'',
        '`': 'aàwẁeèuùiìyỳoòAÀWẀEÈUÙIÌYỲOÒ `',
        '~': 'nñaãoõNÑAÃOÕ ~'
    }
}, {
    ...
    shift: {
        0: '~!ٰءِءَءُ^۽ﯗ()_+ٺَضِڙٽثغهُڦڃڄآشڊلا̈هگحهجه:؛ـذّظاًٻڻ۾“”؟'
    }
}, {
    code: 'UR-PK',
    name: 'Urdu - Madni',
    ...
    shift: {
        0: 'ً!\u0600ئ﷽ٌؐٔ)(ّآؔۡﷺؑڑٹ\u0601ٰٗۃُ\\+ٓصڈٖغحضخؒ:"ذژثظؓںَِ٘؟'
    },
    shift_alt: {
        5: '٪',
        11: '؏\u0603',
    ...
    caps: {
        0: 'ё',
        14: 'йцукенгшщзхъфывапролджэячсмитьбю.'
    },
    shift_caps: {
        2: '"№;',
        6: ':?',
    ...
    shift: {
        0: '~ဍ႑ဋ၌%/ရဂ()×+႒ွ်ၽႊႏၽြႊ႔႕ႈဥဏဧ}ဗွီၤြံဲဳဴၚဓဇဌဃဠႀၿၾဝဈ၊'
    },
    dk: {
        ']': '--×_==++ဟ[ဧ{]]}}၏\\႒|း;ၚ:ဒ\'ဓ"ယ,ဝ<..ဈ>။/၊?``~~၁1ဍ!၂2႑@၃3ဋ#၄4၌$၅5%%၆6/^၇7ရ&၈8ဂ*၉9((၀0))  ',
        '`': 'ဘၻညဉလႅခၡထၳဖၹျႃိႎဒၵ်ၽ္ႍုႉတၱနၷမၼစၥကၠင၍အဤပၸသႆဆၦဂၢရ႐၄၎၅ဩဋၬ၁ၮ၀ဝ  ၿႁဃၣဇၨၾႂဗၺဲႄီႌဓၶွႇၤႋႏ႖ဏၰဥၪႊဣ%ဪ)ဦ၃႗ဌၭ×÷-​႔႕ဈၩဝၯယဎ',
        '~': 'ဆၧတၲထၴညၫဘ႓'
    }
}, {
    code: 'ZU-ZA',
